...
var docs = [
  ...
  {
    type: "doc",
    id: "cloud/cwpp/22-01/cwpp-home",
  },
  {
    type: "doc",
    id: "cloud/cwpp/22-01/stable-endpoints",
  },
  {
    type: "doc",
    id: "cloud/cwpp/22-01/curl-examples",
  },
  {
    type: "doc",
    id: "cloud/cwpp/22-01/how-to-eval-console",
  },
  {
    type: "doc",
    id: "cloud/cwpp/22-01/api-limits",
  },
];

// Change these variables to match your doc path
const relativePath = "cloud/cwpp/22-01";
const absolutePath = "/api/cloud/cwpp/22-01";
function genEndpoints() {
  const endpoints = [];
  const css_overrides = [];
  // Absolute path from project root
  specs = globby.sync(["./static/oas/cwpp/22-01/*.json"], {
    absolute: false,
    objectMode: true,
    deep: 1,
