...
export default {
  ...
  "themeConfig": {
    ...
    "algolia": {
      ...
      "appId": "XC7919KOX3",
      "indexName": "pan",
      "externalUrlRegex": "cortex.pan.dev|xsoar.pan.dev|prisma.pan.dev|gallery.pan.dev|panos.pan.dev",
      "searchParameters": {
        "typoTolerance": false,
        "facetFilters": [
          [
      ...
      "items": [
        {
          ...
          "items": [
            ...
            },
            {
              ...
              "description": "Learn how to make the most of the PAN-OS APIs, SDKs, Expedition, Terraform, Ansible, and more.",
              "products": [
                {
                  "label": "PAN-OS",
                  "to": "#",
            ...
            },
            {
              ...
              "description": "Learn about opportunities across Palo Alto Networks platforms.",
              "products": [
                {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2024 Palo Alto Networks, Inc.",
      "links": []
    },
    "metadata": [],
    "tableOfContents": {
  ...
  "presets": [
    [
      "@docusaurus/preset-classic",
      {
        ...
        "theme": {
          "customCss": [
            "/Users/sserrata/projects/panw/pan.dev/src/css/custom.scss"
          ]
        }
      }
    ]
  ...
  "plugins": [
    ...
    [
      "/Users/sserrata/projects/panw/pan.dev/plugin-sitemap-coveo/src/index.cjs",
      {
        "id": "coveo-sitemap",
        "changefreq": "weekly",
        "priority": 0.5
    ...
    [
      "/Users/sserrata/projects/panw/pan.dev/docusaurus-plugin-gtm/index.js",
      {
        "gtm": "GTM-PLXD79N"
      }
    ]
