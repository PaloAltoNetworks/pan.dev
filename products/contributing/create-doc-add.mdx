...
"csestito": { //My Github ID. Can be found in the URL of your github account, mine is https://github.com/csestito.
    ...
    "image_url": "https://link.to/avatar.png", // URL of the avatar you want to use if you don't want to use your Github avatar.
    "image_url": "/img/avatars/dev.png", //  ALTERNATIVELY: Use the static/img/avatars folder to hold your avatar
  },
```
