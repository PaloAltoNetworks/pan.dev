...
The API Reference information for retrieving threat signature metadata (in batch mode) can be found [here](/threat-vault/api/threat-prevention#operation/threatsbatch).
