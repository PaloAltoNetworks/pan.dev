...
The API Reference information for retrieving the release history for a specified threat signature can be found [here](/threat-vault/api/threat-prevention#operation/threatshistory).
