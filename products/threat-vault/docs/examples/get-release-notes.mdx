...
The API Reference information for retrieving content release note infomation can be found [here](/threat-vault/api/threat-prevention#operation/releasenotes).
