...
slug: /threat-vault/docs/examples/threat-vault/get-content-release-notes
hide_title: false
...
The API Reference information for retrieving content release note infomation can be found [here](/cdss/threat-vault/api/threat-prevention#operation/releasenotes).
