...
The API Reference information for retrieving IPS threat signature metadata can be found [here](/cdss/threat-vault/api/threat-prevention#operation/threats).
    ...
    "data": {
        ...
        "vulnerability": [
            ...
            },
            {
                ...
                "vendor": [],
                "reference": [
                    "https://www.securityfocus.com/bid/12459/exploit"
                ],
                "status": "released",
                "details": {
                    "change_data": "improved detection logic to cover a new exploit"
