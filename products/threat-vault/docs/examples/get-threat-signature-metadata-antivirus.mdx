...
The API Reference information for retrieving antivirus threat signature metadata can be found [here](/threat-vault/api/threat-prevention#operation/threats).
