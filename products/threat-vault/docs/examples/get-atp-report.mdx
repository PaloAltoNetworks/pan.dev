...
The API Reference information for retrieving Advanced Threat Prevention reports based on the report ID can be found [here](/threat-vault/api/advanced-threat-prevention#operation/postatpreportsbatchmode).
