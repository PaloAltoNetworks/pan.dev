---
id: azure-tenant-account-onboarding
title: Automate Azure Cloud Tenant Onboarding
---

Onboarding an Azure Tenant on Prisma Cloud connects all your Azure resources to Prisma Cloud including Accounts with Management Groups, Subscriptions, and Active Directory. Prisma Cloud uses Application (Client) ID, Application Client Secret and Enterprise Application Object ID for authentication to ingest Azure Active Directory metadata, configurations, and logs.


> **Prerequisites**: 
> - In your Azure Tenant, create an app registration, corresponding roles, and Microsoft Graph API Permissions.
