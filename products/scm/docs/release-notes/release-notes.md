...
Posture Management API: 28 new, 15 removed endpoints. Updated from v1.0.0 to v1.1.0.
...
- **List Security Rules with Optimization Recommendations.** New `GET /policy-optimizer/v1/security-rules` endpoint now available.
  [Posture Management API reference →](/scm/api/posture-management)
  ```
  GET api.strata.paloaltonetworks.com/policy-optimizer/v1/security-rules
  ```

- **Get Security Rule Optimization Recommendations.** New `GET /policy-optimizer/v1/security-rules/{id}` endpoint now available.
  [Posture Management API reference →](/scm/api/posture-management)
  ```
  GET api.strata.paloaltonetworks.com/policy-optimizer/v1/security-rules/{id}
  ```

### Removed

- **Get Benchmark Monitoring Data.** The `POST /benchmark-monitoring` endpoint has been removed.
  ```
  POST api.strata.paloaltonetworks.com/benchmark-monitoring
  ```

- **Download Benchmark Data.** The `POST /benchmark-monitoring/download` endpoint has been removed.
  ```
  POST api.strata.paloaltonetworks.com/benchmark-monitoring/download
  ```

- **Get Compliance Controls.** The `GET /compliance-controls/{id}` endpoint has been removed.
  ```
  GET api.strata.paloaltonetworks.com/compliance-controls/{id}
  ```

- **Get Assessed Configurations.** The `GET /configurations-assessed/{id}` endpoint has been removed.
  ```
  GET api.strata.paloaltonetworks.com/configurations-assessed/{id}
  ```

- **List Compliance Frameworks.** The `GET /definitions` endpoint has been removed.
  ```
  GET api.strata.paloaltonetworks.com/definitions
  ```

- **Create Compliance Framework.** The `POST /definitions` endpoint has been removed.
  ```
  POST api.strata.paloaltonetworks.com/definitions
  ```

- **Delete Compliance Framework.** The `DELETE /definitions/{id}` endpoint has been removed.
  ```
  DELETE api.strata.paloaltonetworks.com/definitions/{id}
  ```

- **Get Framework Revision.** The `GET /definitions/{id}` endpoint has been removed.
  ```
  GET api.strata.paloaltonetworks.com/definitions/{id}
  ```

- **Update Compliance Framework.** The `PUT /definitions/{id}` endpoint has been removed.
  ```
  PUT api.strata.paloaltonetworks.com/definitions/{id}
  ```

- **Benchmark Compliance Framework.** The `POST /definitions/{id}:benchmark` endpoint has been removed.
  ```
  POST api.strata.paloaltonetworks.com/definitions/{id}:benchmark
  ```

- **Clone Compliance Framework.** The `POST /definitions/{id}:clone` endpoint has been removed.
  ```
  POST api.strata.paloaltonetworks.com/definitions/{id}:clone
  ```

- **Remove Framework Benchmark.** The `POST /definitions/{id}:un-benchmark` endpoint has been removed.
  ```
  POST api.strata.paloaltonetworks.com/definitions/{id}:un-benchmark
  ```

- **Get Compliance Timeline.** The `GET /overall-compliance-timeline/{id}` endpoint has been removed.
  ```
  GET api.strata.paloaltonetworks.com/overall-compliance-timeline/{id}
  ```

- **Get Framework Compliance Scores.** The `GET /overall-compliance/{id}` endpoint has been removed.
  ```
  GET api.strata.paloaltonetworks.com/overall-compliance/{id}
  ```

- **List Framework Summaries.** The `GET /summaries` endpoint has been removed.
  ```
  GET api.strata.paloaltonetworks.com/summaries
  ```

---
## August 5th, 2026

Policy Optimizer API: 2 new endpoints available.

### New

- **List Security Rules with Optimization Recommendations.** New `GET /security-rules` endpoint now available.
  [Policy Optimizer API reference →](/scm/api/policy-optimizer)
  ```
  GET api.strata.paloaltonetworks.com/security-rules
  ```

- **Get Security Rule Optimization Recommendations.** New `GET /security-rules/{id}` endpoint now available.
  [Policy Optimizer API reference →](/scm/api/policy-optimizer)
  ```
  GET api.strata.paloaltonetworks.com/security-rules/{id}
  ```
