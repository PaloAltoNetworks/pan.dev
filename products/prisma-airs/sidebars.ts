module.exports = {
  ...
  airedteaming_api: [
    {
      type: "doc",
      id: "prisma-airs/api/airedteaming/airedteamingoverview",
    },
    require("./api/airedteaming/sidebar"),
  ],
  aimodelscanning_api: [
    {
      type: "doc",
      id: "prisma-airs/api/aimodelscanning/aimodelscanning",
    },
    require("./api/aimodelscanning/sidebar"),
  ],
};