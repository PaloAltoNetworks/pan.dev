...
- **Get report file (v2.0).** New `GET /sdwan/monitor/reports/v2.0/api/reports` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/monitor/reports/v2.0/api/reports
  ```

- **Get report file (v2.0).** New `POST /sdwan/monitor/reports/v2.0/api/reports/query` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/reports/v2.0/api/reports/query
  ```

- **Get files and folders in specified folder (v2.0).** New `GET /sdwan/monitor/reports/v2.0/api/reportsdir` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/monitor/reports/v2.0/api/reportsdir
  ```

- **Get files and folders in specified folder (v2.0).** New `POST /sdwan/monitor/reports/v2.0/api/reportsdir/query` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/reports/v2.0/api/reportsdir/query
  ```

- **Get download URL for report file (v2.0).** New `GET /sdwan/monitor/reports/v2.0/api/reportsurl` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/monitor/reports/v2.0/api/reportsurl
  ```

- **Radius client metrics (v2.0).** New `POST /sdwan/monitor/v2.0/api/monitor/aaa_client_metrics` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/aaa_client_metrics
  ```

- **Returns radius metrics schema for Version 2.0 (v2.0).** New `GET /sdwan/monitor/v2.0/api/monitor/aaa_metrics` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/aaa_metrics
  ```

- **Radius metrics (v2.0).** New `POST /sdwan/monitor/v2.0/api/monitor/aaa_metrics` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/aaa_metrics
  ```

- **Radius metrics Top N (v2.0).** New `POST /sdwan/monitor/v2.0/api/monitor/aaa_metrics/topn` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/aaa_metrics/topn
  ```

- **Returns interface stats schema for Version 2.0 (v2.0).** New `GET /sdwan/monitor/v2.0/api/monitor/agg_bw_stats` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/agg_bw_stats
  ```

- **Interface Stats (v2.0).** New `POST /sdwan/monitor/v2.0/api/monitor/agg_bw_stats` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/agg_bw_stats
  ```

- **Get aggregate bandwidth statistics (v2.0).** New `POST /sdwan/monitor/v2.0/api/monitor/aggregatebandwidth/query` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/aggregatebandwidth/query
  ```

- **Query Application QOS Aggregates (v2.0).** New `POST /sdwan/monitor/v2.0/api/monitor/aggregates/application/qos` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/aggregates/application/qos
  ```

- **Aggregate Bandwidth API (v2.0).** New `POST /sdwan/monitor/v2.0/api/monitor/aggregates/bandwidth` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/aggregates/bandwidth
  ```

- **Query Multicast statistics (v2.0).** New `POST /sdwan/monitor/v2.0/api/monitor/aggregates/multicast/mroute` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/aggregates/multicast/mroute
  ```

- **Query WAN Neighbor statistics (v2.0).** New `POST /sdwan/monitor/v2.0/api/monitor/aggregates/multicast/wan_neighbor` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/aggregates/multicast/wan_neighbor
  ```

- **Get site or path level aggregated statistics (v2.0).** New `GET /sdwan/monitor/v2.0/api/monitor/aiops/aggregates` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/aiops/aggregates
  ```

- **Query and get site or path level aggregated statistics (v2.0).** New `POST /sdwan/monitor/v2.0/api/monitor/aiops/aggregates` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/aiops/aggregates
  ```

- **Get Healthscore parameters (v2.0).** New `GET /sdwan/monitor/v2.0/api/monitor/aiops/health` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/aiops/health
  ```

- **Healthscore metrics (v2.0).** New `POST /sdwan/monitor/v2.0/api/monitor/aiops/health` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/aiops/health
  ```

- **Get App object statistics (v2.0).** New `GET /sdwan/monitor/v2.0/api/monitor/aiops/object_stats` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/aiops/object_stats
  ```

- **Query and get App object statistics (v2.0).** New `POST /sdwan/monitor/v2.0/api/monitor/aiops/object_stats` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/aiops/object_stats
  ```

- **Query App Acceleration details (v2.0).** New `POST /sdwan/monitor/v2.0/api/monitor/app_acceleration` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/app_acceleration
  ```

- **Query Time series Application QOS metrics (v2.0).** New `POST /sdwan/monitor/v2.0/api/monitor/application/qos_metrics` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/application/qos_metrics
  ```

- **Get details of Application Qos metrics (v2.0).** New `GET /sdwan/monitor/v2.0/api/monitor/application/qos_metrics/{application_name}` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/application/qos_metrics/{application_name}
  ```

- **Query Application users (v2.0).** New `POST /sdwan/monitor/v2.0/api/monitor/application/users` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/application/users
  ```

- **Get application statistics (v2.0).** New `POST /sdwan/monitor/v2.0/api/monitor/applicationstats/query` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/applicationstats/query
  ```

- **Get application summary statistics (v2.0).** New `POST /sdwan/monitor/v2.0/api/monitor/applicationsummary/query` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/applicationsummary/query
  ```

- **Returns cellular metrics schema for Version 2.0 (v2.0).** New `GET /sdwan/monitor/v2.0/api/monitor/cellular_metrics` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/cellular_metrics
  ```

- **Cellular metrics for Version 2.0 (v2.0).** New `POST /sdwan/monitor/v2.0/api/monitor/cellular_metrics` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/cellular_metrics
  ```

- **Cellular metrics Top N (v2.0).** New `POST /sdwan/monitor/v2.0/api/monitor/cellular_metrics/topn` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/cellular_metrics/topn
  ```

- **Insights API (v2.0).** New `POST /sdwan/monitor/v2.0/api/monitor/insights` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/insights
  ```

- **Insights List API (v2.0).** New `POST /sdwan/monitor/v2.0/api/monitor/insightslist` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/insightslist
  ```

- **LQM Point metrics (v2.0).** New `POST /sdwan/monitor/v2.0/api/monitor/lqm_point_metrics` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/lqm_point_metrics
  ```

- **Query and get probe monitor metrics (v2.0).** New `POST /sdwan/monitor/v2.0/api/monitor/metrics/probes` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/metrics/probes
  ```

- **Get details of probe monitor metrics (v2.0).** New `GET /sdwan/monitor/v2.0/api/monitor/metrics/probes/{mtype}` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/metrics/probes/{mtype}
  ```

- **Network Point Metrics BandwidthUsage (v2.0).** New `POST /sdwan/monitor/v2.0/api/monitor/network_point_metrics` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/network_point_metrics
  ```

- **Network Point Metrics BandwidthUsage (v2.0).** New `POST /sdwan/monitor/v2.0/api/monitor/network_point_metrics_bw` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/network_point_metrics_bw
  ```

- **Network Point Metrics HealthScore (v2.0).** New `POST /sdwan/monitor/v2.0/api/monitor/network_point_metrics_hs` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/network_point_metrics_hs
  ```

- **Probe Point metrics (v2.0).** New `POST /sdwan/monitor/v2.0/api/monitor/probe_point_metrics` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/probe_point_metrics
  ```

- **Get details of Qos metrics (v2.0).** New `GET /sdwan/monitor/v2.0/api/monitor/qos_metrics` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/qos_metrics
  ```

- **Query Qos metrics (v2.0).** New `POST /sdwan/monitor/v2.0/api/monitor/qos_metrics` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/qos_metrics
  ```

- **Sysmetrics Top N (v2.0).** New `POST /sdwan/monitor/v2.0/api/monitor/sys_metrics/topn` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/sys_metrics/topn
  ```

- **Sys Point metrics (v2.0).** New `POST /sdwan/monitor/v2.0/api/monitor/sys_point_metrics` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/sys_point_metrics
  ```

- **Top N Traffic Volume Stats (v2.0).** New `POST /sdwan/monitor/v2.0/api/monitor/topn_traffic_vol/query` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.0/api/monitor/topn_traffic_vol/query
  ```

- **Aggregate HealthScore (v2.1).** New `POST /sdwan/monitor/v2.1/api/monitor/aggregates/healthscore` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.1/api/monitor/aggregates/healthscore
  ```

- **Get site or path level aggregated statistics (v2.1).** New `GET /sdwan/monitor/v2.1/api/monitor/aiops/aggregates` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/monitor/v2.1/api/monitor/aiops/aggregates
  ```

- **Query and get site or path level aggregated statistics (v2.1).** New `POST /sdwan/monitor/v2.1/api/monitor/aiops/aggregates` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.1/api/monitor/aiops/aggregates
  ```

- **Get App object statistics (v2.1).** New `GET /sdwan/monitor/v2.1/api/monitor/aiops/object_stats` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/monitor/v2.1/api/monitor/aiops/object_stats
  ```

- **Query and get App object statistics (v2.1).** New `POST /sdwan/monitor/v2.1/api/monitor/aiops/object_stats` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.1/api/monitor/aiops/object_stats
  ```

- **Cellular metrics for Version 2.1 (v2.1).** New `POST /sdwan/monitor/v2.1/api/monitor/cellular_metrics` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.1/api/monitor/cellular_metrics
  ```

- **Sysmetrics Top N V2.1 (v2.1).** New `POST /sdwan/monitor/v2.1/api/monitor/sys_metrics/topn` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.1/api/monitor/sys_metrics/topn
  ```

- **Returns sysmetrics schema for Version 2.3 (v2.3).** New `GET /sdwan/monitor/v2.3/api/monitor/sys_metrics` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/monitor/v2.3/api/monitor/sys_metrics
  ```

- **System metrics for Version 2.3 (v2.3).** New `POST /sdwan/monitor/v2.3/api/monitor/sys_metrics` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.3/api/monitor/sys_metrics
  ```

- **Returns sysmetrics schema for Version 2.4 (v2.4).** New `GET /sdwan/monitor/v2.4/api/monitor/sys_metrics` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/monitor/v2.4/api/monitor/sys_metrics
  ```

- **System metrics for Version 2.4 (v2.4).** New `POST /sdwan/monitor/v2.4/api/monitor/sys_metrics` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.4/api/monitor/sys_metrics
  ```

- **Get details of monitor metrics (v2.5).** New `GET /sdwan/monitor/v2.5/api/monitor/metrics/{mtype}` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/monitor/v2.5/api/monitor/metrics/{mtype}
  ```

- **Query and get monitor metrics (v2.6).** New `POST /sdwan/monitor/v2.6/api/monitor/metrics` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.6/api/monitor/metrics
  ```

- **Get details of monitor metrics (v2.6).** New `GET /sdwan/monitor/v2.6/api/monitor/metrics/{mtype}` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/monitor/v2.6/api/monitor/metrics/{mtype}
  ```

- **Get name and description of all object statistics (v2.6).** New `GET /sdwan/monitor/v2.6/api/monitor/object_stats` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/monitor/v2.6/api/monitor/object_stats
  ```

- **Query and get object statistics (v2.6).** New `POST /sdwan/monitor/v2.6/api/monitor/object_stats` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.6/api/monitor/object_stats
  ```

- **Query and get monitor metrics (v2.7).** New `POST /sdwan/monitor/v2.7/api/monitor/metrics` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.7/api/monitor/metrics
  ```

- **Get name and description of all object statistics (v2.7).** New `GET /sdwan/monitor/v2.7/api/monitor/object_stats` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/monitor/v2.7/api/monitor/object_stats
  ```

- **Query and get object statistics (v2.7).** New `POST /sdwan/monitor/v2.7/api/monitor/object_stats` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v2.7/api/monitor/object_stats
  ```

- **Supported App stats Aggregates (v3.0).** New `GET /sdwan/monitor/v3.0/api/monitor/aggregates` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/monitor/v3.0/api/monitor/aggregates
  ```

- **Aggregate App stats (v3.0).** New `POST /sdwan/monitor/v3.0/api/monitor/aggregates` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v3.0/api/monitor/aggregates
  ```

- **LQM Point metrics distribution (v3.0).** New `POST /sdwan/monitor/v3.0/api/monitor/distributions/{metric_name}` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v3.0/api/monitor/distributions/{metric_name}
  ```

- **Top N (v3.0).** New `POST /sdwan/monitor/v3.0/api/monitor/topn` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v3.0/api/monitor/topn
  ```

- **Top N (v3.1).** New `POST /sdwan/monitor/v3.1/api/monitor/topn` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v3.1/api/monitor/topn
  ```

- **Flows (v3.12).** New `POST /sdwan/monitor/v3.12/api/monitor/flows` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v3.12/api/monitor/flows
  ```

- **Flows (v3.13).** New `POST /sdwan/monitor/v3.13/api/monitor/flows` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/monitor/v3.13/api/monitor/flows
  ```
...
- **Get Cuid Status. (v2.0).** New `GET /sdwan/v2.0/api/cuid/status` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/v2.0/api/cuid/status
  ```
...
- **Query Element correlation events. (v2.0).** New `POST /sdwan/v2.0/api/elements/correlationevents/query` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/v2.0/api/elements/correlationevents/query
  ```
...
- **Get name and description of all event codes (v2.0).** New `GET /sdwan/v2.0/api/eventcodes` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/v2.0/api/eventcodes
  ```
...
- **EventOperationsAPI (v2.0).** New `POST /sdwan/v2.0/api/events/operations` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/v2.0/api/events/operations
  ```

- **EventSummaryAPI (v2.0).** New `POST /sdwan/v2.0/api/events/summary` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/v2.0/api/events/summary
  ```
...
- **Delete a existing CertificateAuthorityConfigDO object by tenant ID and ID (v2.0).** New `DELETE /sdwan/v2.0/api/externalcaconfigs/{id}` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  DELETE api.sase.paloaltonetworks.com/sdwan/v2.0/api/externalcaconfigs/{id}
  ```

- **Retrieve an existing CertificateAuthorityConfigDO object by tenant ID and ID (v2.0).** New `GET /sdwan/v2.0/api/externalcaconfigs/{id}` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/v2.0/api/externalcaconfigs/{id}
  ```

- **Update an existing certificate authority configuration (v2.0).** New `PUT /sdwan/v2.0/api/externalcaconfigs/{id}` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  PUT api.sase.paloaltonetworks.com/sdwan/v2.0/api/externalcaconfigs/{id}
  ```
...
- **Query Interface correlation events. (v2.0).** New `POST /sdwan/v2.0/api/interfaces/correlationevents/query` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/v2.0/api/interfaces/correlationevents/query
  ```
...
- **Query site correlation events. (v2.0).** New `POST /sdwan/v2.0/api/sites/correlationevents/query` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/v2.0/api/sites/correlationevents/query
  ```
...
- **Get site correlation events. (v2.0).** New `GET /sdwan/v2.0/api/sites/{site_id}/correlationevents` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/v2.0/api/sites/{site_id}/correlationevents
  ```
...
- **Get element events. (v2.0).** New `GET /sdwan/v2.0/api/sites/{site_id}/elements/{element_id}/correlationevents` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/v2.0/api/sites/{site_id}/elements/{element_id}/correlationevents
  ```
...
- **Get Interface correlation events. (v2.0).** New `GET /sdwan/v2.0/api/sites/{site_id}/elements/{element_id}/interfaces/{interface_id}/correlationevents` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/v2.0/api/sites/{site_id}/elements/{element_id}/interfaces/{interface_id}/correlationevents
  ```
...
- **Delete Path Prefix Distribution Filter Association (v2.0).** New `DELETE /sdwan/v2.0/api/sites/{site_id}/pathprefixdistributionfilterassociation/{id}` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  DELETE api.sase.paloaltonetworks.com/sdwan/v2.0/api/sites/{site_id}/pathprefixdistributionfilterassociation/{id}
  ```

- **Get Path Prefix Distribution Filter Association (v2.0).** New `GET /sdwan/v2.0/api/sites/{site_id}/pathprefixdistributionfilterassociation/{id}` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/v2.0/api/sites/{site_id}/pathprefixdistributionfilterassociation/{id}
  ```

- **Update Path Prefix Distribution Filter Association (v2.0).** New `PUT /sdwan/v2.0/api/sites/{site_id}/pathprefixdistributionfilterassociation/{id}` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  PUT api.sase.paloaltonetworks.com/sdwan/v2.0/api/sites/{site_id}/pathprefixdistributionfilterassociation/{id}
  ```
...
- **Delete Path Prefix Distribution Filters List (v2.0).** New `DELETE /sdwan/v2.0/api/sites/{site_id}/pathprefixdistributionfilters/{id}` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  DELETE api.sase.paloaltonetworks.com/sdwan/v2.0/api/sites/{site_id}/pathprefixdistributionfilters/{id}
  ```

- **Get Path Prefix Distribution filters List (v2.0).** New `GET /sdwan/v2.0/api/sites/{site_id}/pathprefixdistributionfilters/{id}` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/v2.0/api/sites/{site_id}/pathprefixdistributionfilters/{id}
  ```

- **Update Path Prefix Distribution Filters List (v2.0).** New `PUT /sdwan/v2.0/api/sites/{site_id}/pathprefixdistributionfilters/{id}` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  PUT api.sase.paloaltonetworks.com/sdwan/v2.0/api/sites/{site_id}/pathprefixdistributionfilters/{id}
  ```
...
- **Delete Prefix Distribution Spoke List (v2.0).** New `DELETE /sdwan/v2.0/api/sites/{site_id}/prefixdistributionspokelists/{id}` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  DELETE api.sase.paloaltonetworks.com/sdwan/v2.0/api/sites/{site_id}/prefixdistributionspokelists/{id}
  ```

- **Get Prefix Distribution Spoke List (v2.0).** New `GET /sdwan/v2.0/api/sites/{site_id}/prefixdistributionspokelists/{id}` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/v2.0/api/sites/{site_id}/prefixdistributionspokelists/{id}
  ```

- **Update Prefix Distribution Spoke List (v2.0).** New `PUT /sdwan/v2.0/api/sites/{site_id}/prefixdistributionspokelists/{id}` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  PUT api.sase.paloaltonetworks.com/sdwan/v2.0/api/sites/{site_id}/prefixdistributionspokelists/{id}
  ```
...
- **Get Wan Interface correlation events. (v2.0).** New `GET /sdwan/v2.0/api/sites/{site_id}/waninterfaces/{wan_interface_id}/correlationevents` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/v2.0/api/sites/{site_id}/waninterfaces/{wan_interface_id}/correlationevents
  ```
...
- **Aggregate HealthScore (v2.0).** New `POST /sdwan/v2.0/api/tenants/{esp_tenant_id}/monitor/aggregates/healthscore` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/v2.0/api/tenants/{esp_tenant_id}/monitor/aggregates/healthscore
  ```
...
- **Query WAN Interface correlation events. (v2.0).** New `POST /sdwan/v2.0/api/waninterfaces/correlationevents/query` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/v2.0/api/waninterfaces/correlationevents/query
  ```
...
- **Query AnynetLink correlation events. (v2.1).** New `POST /sdwan/v2.1/api/anynetlinks/correlationevents/query` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/v2.1/api/anynetlinks/correlationevents/query
  ```

- **Get AnynetLink correlation events. (v2.1).** New `GET /sdwan/v2.1/api/anynetlinks/{anynetlink_id}/correlationevents` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/v2.1/api/anynetlinks/{anynetlink_id}/correlationevents
  ```
...
- **Query Element correlation events. (v2.1).** New `POST /sdwan/v2.1/api/elements/correlationevents/query` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/v2.1/api/elements/correlationevents/query
  ```
...
- **EventSummaryAPI (v2.1).** New `POST /sdwan/v2.1/api/events/summary` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/v2.1/api/events/summary
  ```

- **Query Interface correlation events. (v2.1).** New `POST /sdwan/v2.1/api/interfaces/correlationevents/query` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/v2.1/api/interfaces/correlationevents/query
  ```
...
- **Query site correlation events. (v2.1).** New `POST /sdwan/v2.1/api/sites/correlationevents/query` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/v2.1/api/sites/correlationevents/query
  ```

- **Get site correlation events. (v2.1).** New `GET /sdwan/v2.1/api/sites/{site_id}/correlationevents` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/v2.1/api/sites/{site_id}/correlationevents
  ```
...
- **Get element events. (v2.1).** New `GET /sdwan/v2.1/api/sites/{site_id}/elements/{element_id}/correlationevents` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/v2.1/api/sites/{site_id}/elements/{element_id}/correlationevents
  ```

- **Get Interface correlation events. (v2.1).** New `GET /sdwan/v2.1/api/sites/{site_id}/elements/{element_id}/interfaces/{interface_id}/correlationevents` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/v2.1/api/sites/{site_id}/elements/{element_id}/interfaces/{interface_id}/correlationevents
  ```
...
- **Get Wan Interface correlation events. (v2.1).** New `GET /sdwan/v2.1/api/sites/{site_id}/waninterfaces/{wan_interface_id}/correlationevents` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/v2.1/api/sites/{site_id}/waninterfaces/{wan_interface_id}/correlationevents
  ```
...
- **Query WAN Interface correlation events. (v2.1).** New `POST /sdwan/v2.1/api/waninterfaces/correlationevents/query` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/v2.1/api/waninterfaces/correlationevents/query
  ```
...
- **Query AnynetLink correlation events. (v2.2).** New `POST /sdwan/v2.2/api/anynetlinks/correlationevents/query` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/v2.2/api/anynetlinks/correlationevents/query
  ```

- **Get AnynetLink correlation events. (v2.2).** New `GET /sdwan/v2.2/api/anynetlinks/{anynetlink_id}/correlationevents` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/v2.2/api/anynetlinks/{anynetlink_id}/correlationevents
  ```
...
- **Get Events API (v2.3).** New `GET /sdwan/v2.3/api/events/{event_id}` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/v2.3/api/events/{event_id}
  ```

- **Put Events API (v2.3).** New `PUT /sdwan/v2.3/api/events/{event_id}` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  PUT api.sase.paloaltonetworks.com/sdwan/v2.3/api/events/{event_id}
  ```
...
- **Get Events API (v2.4).** New `GET /sdwan/v2.4/api/events/{event_id}` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  GET api.sase.paloaltonetworks.com/sdwan/v2.4/api/events/{event_id}
  ```

- **Put Events API (v2.4).** New `PUT /sdwan/v2.4/api/events/{event_id}` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  PUT api.sase.paloaltonetworks.com/sdwan/v2.4/api/events/{event_id}
  ```
...
- **EventsQueryAPI (v3.6).** New `POST /sdwan/v3.6/api/events/query` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/v3.6/api/events/query
  ```
...
- **EventsQueryAPI (v3.7).** New `POST /sdwan/v3.7/api/events/query` endpoint now available.
  [Unified API reference →](/sase/api/unified)
  ```
  POST api.sase.paloaltonetworks.com/sdwan/v3.7/api/events/query
  ```
...
Legacy API: 1555 new endpoints available.
...
- **Aggregate HealthScore (v2.0).** New `POST /v2.0/api/tenants/{esp_tenant_id}/monitor/aggregates/healthscore` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{esp_tenant_id}/monitor/aggregates/healthscore
  ```
...
- **Get Cuid Status. (v2.0).** New `GET /v2.0/api/tenants/{tenant_id}/cuid/status` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/cuid/status
  ```
...
- **Query Element correlation events. (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/elements/correlationevents/query` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/elements/correlationevents/query
  ```
...
- **Get name and description of all event codes (v2.0).** New `GET /v2.0/api/tenants/{tenant_id}/eventcodes` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/eventcodes
  ```
...
- **EventOperationsAPI (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/events/operations` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/events/operations
  ```

- **EventSummaryAPI (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/events/summary` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/events/summary
  ```
...
- **Delete a existing CertificateAuthorityConfigDO object by tenant ID and ID (v2.0).** New `DELETE /v2.0/api/tenants/{tenant_id}/externalcaconfigs/{id}` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  DELETE api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/externalcaconfigs/{id}
  ```

- **Retrieve an existing CertificateAuthorityConfigDO object by tenant ID and ID (v2.0).** New `GET /v2.0/api/tenants/{tenant_id}/externalcaconfigs/{id}` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/externalcaconfigs/{id}
  ```

- **Update an existing certificate authority configuration (v2.0).** New `PUT /v2.0/api/tenants/{tenant_id}/externalcaconfigs/{id}` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  PUT api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/externalcaconfigs/{id}
  ```
...
- **Query Interface correlation events. (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/interfaces/correlationevents/query` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/interfaces/correlationevents/query
  ```
...
- **Radius client metrics (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/monitor/aaa_client_metrics` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/aaa_client_metrics
  ```

- **Returns radius metrics schema for Version 2.0 (v2.0).** New `GET /v2.0/api/tenants/{tenant_id}/monitor/aaa_metrics` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/aaa_metrics
  ```

- **Radius metrics (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/monitor/aaa_metrics` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/aaa_metrics
  ```

- **Radius metrics Top N (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/monitor/aaa_metrics/topn` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/aaa_metrics/topn
  ```

- **Returns interface stats schema for Version 2.0 (v2.0).** New `GET /v2.0/api/tenants/{tenant_id}/monitor/agg_bw_stats` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/agg_bw_stats
  ```

- **Interface Stats (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/monitor/agg_bw_stats` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/agg_bw_stats
  ```

- **Get aggregate bandwidth statistics (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/monitor/aggregatebandwidth/query` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/aggregatebandwidth/query
  ```

- **Query Application QOS Aggregates (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/monitor/aggregates/application/qos` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/aggregates/application/qos
  ```

- **Aggregate Bandwidth API (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/monitor/aggregates/bandwidth` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/aggregates/bandwidth
  ```

- **Query Multicast statistics (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/monitor/aggregates/multicast/mroute` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/aggregates/multicast/mroute
  ```

- **Query WAN Neighbor statistics (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/monitor/aggregates/multicast/wan_neighbor` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/aggregates/multicast/wan_neighbor
  ```

- **Get site or path level aggregated statistics (v2.0).** New `GET /v2.0/api/tenants/{tenant_id}/monitor/aiops/aggregates` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/aiops/aggregates
  ```

- **Query and get site or path level aggregated statistics (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/monitor/aiops/aggregates` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/aiops/aggregates
  ```

- **Get Healthscore parameters (v2.0).** New `GET /v2.0/api/tenants/{tenant_id}/monitor/aiops/health` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/aiops/health
  ```

- **Healthscore metrics (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/monitor/aiops/health` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/aiops/health
  ```

- **Get App object statistics (v2.0).** New `GET /v2.0/api/tenants/{tenant_id}/monitor/aiops/object_stats` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/aiops/object_stats
  ```

- **Query and get App object statistics (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/monitor/aiops/object_stats` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/aiops/object_stats
  ```

- **Query App Acceleration details (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/monitor/app_acceleration` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/app_acceleration
  ```

- **Query Time series Application QOS metrics (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/monitor/application/qos_metrics` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/application/qos_metrics
  ```

- **Get details of Application Qos metrics (v2.0).** New `GET /v2.0/api/tenants/{tenant_id}/monitor/application/qos_metrics/{application_name}` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/application/qos_metrics/{application_name}
  ```

- **Query Application users (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/monitor/application/users` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/application/users
  ```

- **Get application statistics (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/monitor/applicationstats/query` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/applicationstats/query
  ```

- **Get application summary statistics (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/monitor/applicationsummary/query` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/applicationsummary/query
  ```

- **Returns cellular metrics schema for Version 2.0 (v2.0).** New `GET /v2.0/api/tenants/{tenant_id}/monitor/cellular_metrics` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/cellular_metrics
  ```

- **Cellular metrics for Version 2.0 (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/monitor/cellular_metrics` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/cellular_metrics
  ```

- **Cellular metrics Top N (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/monitor/cellular_metrics/topn` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/cellular_metrics/topn
  ```

- **Insights API (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/monitor/insights` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/insights
  ```

- **Insights List API (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/monitor/insightslist` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/insightslist
  ```

- **LQM Point metrics (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/monitor/lqm_point_metrics` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/lqm_point_metrics
  ```

- **Query and get probe monitor metrics (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/monitor/metrics/probes` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/metrics/probes
  ```

- **Get details of probe monitor metrics (v2.0).** New `GET /v2.0/api/tenants/{tenant_id}/monitor/metrics/probes/{mtype}` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/metrics/probes/{mtype}
  ```

- **Network Point Metrics BandwidthUsage (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/monitor/network_point_metrics` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/network_point_metrics
  ```

- **Network Point Metrics BandwidthUsage (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/monitor/network_point_metrics_bw` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/network_point_metrics_bw
  ```

- **Network Point Metrics HealthScore (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/monitor/network_point_metrics_hs` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/network_point_metrics_hs
  ```

- **Probe Point metrics (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/monitor/probe_point_metrics` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/probe_point_metrics
  ```

- **Get details of Qos metrics (v2.0).** New `GET /v2.0/api/tenants/{tenant_id}/monitor/qos_metrics` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/qos_metrics
  ```

- **Query Qos metrics (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/monitor/qos_metrics` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/qos_metrics
  ```

- **Sysmetrics Top N (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/monitor/sys_metrics/topn` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/sys_metrics/topn
  ```

- **Sys Point metrics (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/monitor/sys_point_metrics` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/sys_point_metrics
  ```

- **Top N Traffic Volume Stats (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/monitor/topn_traffic_vol/query` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/monitor/topn_traffic_vol/query
  ```
...
- **Get report file (v2.0).** New `GET /v2.0/api/tenants/{tenant_id}/reports` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/reports
  ```

- **Get report file (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/reports/query` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/reports/query
  ```

- **Get files and folders in specified folder (v2.0).** New `GET /v2.0/api/tenants/{tenant_id}/reportsdir` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/reportsdir
  ```

- **Get files and folders in specified folder (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/reportsdir/query` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/reportsdir/query
  ```

- **Get download URL for report file (v2.0).** New `GET /v2.0/api/tenants/{tenant_id}/reportsurl` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/reportsurl
  ```
...
- **Query site correlation events. (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/sites/correlationevents/query` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/sites/correlationevents/query
  ```
...
- **Get site correlation events. (v2.0).** New `GET /v2.0/api/tenants/{tenant_id}/sites/{site_id}/correlationevents` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/sites/{site_id}/correlationevents
  ```
...
- **Get element events. (v2.0).** New `GET /v2.0/api/tenants/{tenant_id}/sites/{site_id}/elements/{element_id}/correlationevents` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/sites/{site_id}/elements/{element_id}/correlationevents
  ```
...
- **Get Interface correlation events. (v2.0).** New `GET /v2.0/api/tenants/{tenant_id}/sites/{site_id}/elements/{element_id}/interfaces/{interface_id}/correlationevents` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/sites/{site_id}/elements/{element_id}/interfaces/{interface_id}/correlationevents
  ```
...
- **Delete Path Prefix Distribution Filter Association (v2.0).** New `DELETE /v2.0/api/tenants/{tenant_id}/sites/{site_id}/pathprefixdistributionfilterassociation/{id}` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  DELETE api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/sites/{site_id}/pathprefixdistributionfilterassociation/{id}
  ```

- **Get Path Prefix Distribution Filter Association (v2.0).** New `GET /v2.0/api/tenants/{tenant_id}/sites/{site_id}/pathprefixdistributionfilterassociation/{id}` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/sites/{site_id}/pathprefixdistributionfilterassociation/{id}
  ```

- **Update Path Prefix Distribution Filter Association (v2.0).** New `PUT /v2.0/api/tenants/{tenant_id}/sites/{site_id}/pathprefixdistributionfilterassociation/{id}` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  PUT api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/sites/{site_id}/pathprefixdistributionfilterassociation/{id}
  ```
...
- **Delete Path Prefix Distribution Filters List (v2.0).** New `DELETE /v2.0/api/tenants/{tenant_id}/sites/{site_id}/pathprefixdistributionfilters/{id}` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  DELETE api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/sites/{site_id}/pathprefixdistributionfilters/{id}
  ```

- **Get Path Prefix Distribution filters List (v2.0).** New `GET /v2.0/api/tenants/{tenant_id}/sites/{site_id}/pathprefixdistributionfilters/{id}` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/sites/{site_id}/pathprefixdistributionfilters/{id}
  ```

- **Update Path Prefix Distribution Filters List (v2.0).** New `PUT /v2.0/api/tenants/{tenant_id}/sites/{site_id}/pathprefixdistributionfilters/{id}` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  PUT api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/sites/{site_id}/pathprefixdistributionfilters/{id}
  ```
...
- **Delete Prefix Distribution Spoke List (v2.0).** New `DELETE /v2.0/api/tenants/{tenant_id}/sites/{site_id}/prefixdistributionspokelists/{id}` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  DELETE api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/sites/{site_id}/prefixdistributionspokelists/{id}
  ```

- **Get Prefix Distribution Spoke List (v2.0).** New `GET /v2.0/api/tenants/{tenant_id}/sites/{site_id}/prefixdistributionspokelists/{id}` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/sites/{site_id}/prefixdistributionspokelists/{id}
  ```

- **Update Prefix Distribution Spoke List (v2.0).** New `PUT /v2.0/api/tenants/{tenant_id}/sites/{site_id}/prefixdistributionspokelists/{id}` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  PUT api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/sites/{site_id}/prefixdistributionspokelists/{id}
  ```
...
- **Get Wan Interface correlation events. (v2.0).** New `GET /v2.0/api/tenants/{tenant_id}/sites/{site_id}/waninterfaces/{wan_interface_id}/correlationevents` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/sites/{site_id}/waninterfaces/{wan_interface_id}/correlationevents
  ```
...
- **Query WAN Interface correlation events. (v2.0).** New `POST /v2.0/api/tenants/{tenant_id}/waninterfaces/correlationevents/query` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.0/api/tenants/{tenant_id}/waninterfaces/correlationevents/query
  ```
...
- **Query AnynetLink correlation events. (v2.1).** New `POST /v2.1/api/tenants/{tenant_id}/anynetlinks/correlationevents/query` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.1/api/tenants/{tenant_id}/anynetlinks/correlationevents/query
  ```

- **Get AnynetLink correlation events. (v2.1).** New `GET /v2.1/api/tenants/{tenant_id}/anynetlinks/{anynetlink_id}/correlationevents` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.1/api/tenants/{tenant_id}/anynetlinks/{anynetlink_id}/correlationevents
  ```
...
- **Query Element correlation events. (v2.1).** New `POST /v2.1/api/tenants/{tenant_id}/elements/correlationevents/query` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.1/api/tenants/{tenant_id}/elements/correlationevents/query
  ```
...
- **EventSummaryAPI (v2.1).** New `POST /v2.1/api/tenants/{tenant_id}/events/summary` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.1/api/tenants/{tenant_id}/events/summary
  ```

- **Query Interface correlation events. (v2.1).** New `POST /v2.1/api/tenants/{tenant_id}/interfaces/correlationevents/query` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.1/api/tenants/{tenant_id}/interfaces/correlationevents/query
  ```
...
- **Aggregate HealthScore (v2.1).** New `POST /v2.1/api/tenants/{tenant_id}/monitor/aggregates/healthscore` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.1/api/tenants/{tenant_id}/monitor/aggregates/healthscore
  ```

- **Get site or path level aggregated statistics (v2.1).** New `GET /v2.1/api/tenants/{tenant_id}/monitor/aiops/aggregates` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.1/api/tenants/{tenant_id}/monitor/aiops/aggregates
  ```

- **Query and get site or path level aggregated statistics (v2.1).** New `POST /v2.1/api/tenants/{tenant_id}/monitor/aiops/aggregates` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.1/api/tenants/{tenant_id}/monitor/aiops/aggregates
  ```

- **Get App object statistics (v2.1).** New `GET /v2.1/api/tenants/{tenant_id}/monitor/aiops/object_stats` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.1/api/tenants/{tenant_id}/monitor/aiops/object_stats
  ```

- **Query and get App object statistics (v2.1).** New `POST /v2.1/api/tenants/{tenant_id}/monitor/aiops/object_stats` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.1/api/tenants/{tenant_id}/monitor/aiops/object_stats
  ```

- **Cellular metrics for Version 2.1 (v2.1).** New `POST /v2.1/api/tenants/{tenant_id}/monitor/cellular_metrics` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.1/api/tenants/{tenant_id}/monitor/cellular_metrics
  ```

- **Sysmetrics Top N V2.1 (v2.1).** New `POST /v2.1/api/tenants/{tenant_id}/monitor/sys_metrics/topn` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.1/api/tenants/{tenant_id}/monitor/sys_metrics/topn
  ```
...
- **Query site correlation events. (v2.1).** New `POST /v2.1/api/tenants/{tenant_id}/sites/correlationevents/query` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.1/api/tenants/{tenant_id}/sites/correlationevents/query
  ```

- **Get site correlation events. (v2.1).** New `GET /v2.1/api/tenants/{tenant_id}/sites/{site_id}/correlationevents` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.1/api/tenants/{tenant_id}/sites/{site_id}/correlationevents
  ```
...
- **Get element events. (v2.1).** New `GET /v2.1/api/tenants/{tenant_id}/sites/{site_id}/elements/{element_id}/correlationevents` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.1/api/tenants/{tenant_id}/sites/{site_id}/elements/{element_id}/correlationevents
  ```

- **Get Interface correlation events. (v2.1).** New `GET /v2.1/api/tenants/{tenant_id}/sites/{site_id}/elements/{element_id}/interfaces/{interface_id}/correlationevents` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.1/api/tenants/{tenant_id}/sites/{site_id}/elements/{element_id}/interfaces/{interface_id}/correlationevents
  ```
...
- **Get Wan Interface correlation events. (v2.1).** New `GET /v2.1/api/tenants/{tenant_id}/sites/{site_id}/waninterfaces/{wan_interface_id}/correlationevents` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.1/api/tenants/{tenant_id}/sites/{site_id}/waninterfaces/{wan_interface_id}/correlationevents
  ```
...
- **Query WAN Interface correlation events. (v2.1).** New `POST /v2.1/api/tenants/{tenant_id}/waninterfaces/correlationevents/query` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.1/api/tenants/{tenant_id}/waninterfaces/correlationevents/query
  ```
...
- **Query AnynetLink correlation events. (v2.2).** New `POST /v2.2/api/tenants/{tenant_id}/anynetlinks/correlationevents/query` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.2/api/tenants/{tenant_id}/anynetlinks/correlationevents/query
  ```

- **Get AnynetLink correlation events. (v2.2).** New `GET /v2.2/api/tenants/{tenant_id}/anynetlinks/{anynetlink_id}/correlationevents` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.2/api/tenants/{tenant_id}/anynetlinks/{anynetlink_id}/correlationevents
  ```
...
- **Get Events API (v2.3).** New `GET /v2.3/api/tenants/{tenant_id}/events/{event_id}` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.3/api/tenants/{tenant_id}/events/{event_id}
  ```

- **Put Events API (v2.3).** New `PUT /v2.3/api/tenants/{tenant_id}/events/{event_id}` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  PUT api.sase.paloaltonetworks.com/v2.3/api/tenants/{tenant_id}/events/{event_id}
  ```
...
- **Returns sysmetrics schema for Version 2.3 (v2.3).** New `GET /v2.3/api/tenants/{tenant_id}/monitor/sys_metrics` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.3/api/tenants/{tenant_id}/monitor/sys_metrics
  ```

- **System metrics for Version 2.3 (v2.3).** New `POST /v2.3/api/tenants/{tenant_id}/monitor/sys_metrics` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.3/api/tenants/{tenant_id}/monitor/sys_metrics
  ```
...
- **Get Events API (v2.4).** New `GET /v2.4/api/tenants/{tenant_id}/events/{event_id}` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.4/api/tenants/{tenant_id}/events/{event_id}
  ```

- **Put Events API (v2.4).** New `PUT /v2.4/api/tenants/{tenant_id}/events/{event_id}` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  PUT api.sase.paloaltonetworks.com/v2.4/api/tenants/{tenant_id}/events/{event_id}
  ```

- **Returns sysmetrics schema for Version 2.4 (v2.4).** New `GET /v2.4/api/tenants/{tenant_id}/monitor/sys_metrics` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.4/api/tenants/{tenant_id}/monitor/sys_metrics
  ```

- **System metrics for Version 2.4 (v2.4).** New `POST /v2.4/api/tenants/{tenant_id}/monitor/sys_metrics` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.4/api/tenants/{tenant_id}/monitor/sys_metrics
  ```
...
- **Get details of monitor metrics (v2.5).** New `GET /v2.5/api/tenants/{tenant_id}/monitor/metrics/{mtype}` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.5/api/tenants/{tenant_id}/monitor/metrics/{mtype}
  ```
...
- **Query and get monitor metrics (v2.6).** New `POST /v2.6/api/tenants/{tenant_id}/monitor/metrics` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.6/api/tenants/{tenant_id}/monitor/metrics
  ```

- **Get details of monitor metrics (v2.6).** New `GET /v2.6/api/tenants/{tenant_id}/monitor/metrics/{mtype}` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.6/api/tenants/{tenant_id}/monitor/metrics/{mtype}
  ```

- **Get name and description of all object statistics (v2.6).** New `GET /v2.6/api/tenants/{tenant_id}/monitor/object_stats` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.6/api/tenants/{tenant_id}/monitor/object_stats
  ```

- **Query and get object statistics (v2.6).** New `POST /v2.6/api/tenants/{tenant_id}/monitor/object_stats` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.6/api/tenants/{tenant_id}/monitor/object_stats
  ```
...
- **Query and get monitor metrics (v2.7).** New `POST /v2.7/api/tenants/{tenant_id}/monitor/metrics` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.7/api/tenants/{tenant_id}/monitor/metrics
  ```

- **Get name and description of all object statistics (v2.7).** New `GET /v2.7/api/tenants/{tenant_id}/monitor/object_stats` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v2.7/api/tenants/{tenant_id}/monitor/object_stats
  ```

- **Query and get object statistics (v2.7).** New `POST /v2.7/api/tenants/{tenant_id}/monitor/object_stats` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v2.7/api/tenants/{tenant_id}/monitor/object_stats
  ```
...
- **Supported App stats Aggregates (v3.0).** New `GET /v3.0/api/tenants/{tenant_id}/monitor/aggregates` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  GET api.sase.paloaltonetworks.com/v3.0/api/tenants/{tenant_id}/monitor/aggregates
  ```

- **Aggregate App stats (v3.0).** New `POST /v3.0/api/tenants/{tenant_id}/monitor/aggregates` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v3.0/api/tenants/{tenant_id}/monitor/aggregates
  ```

- **LQM Point metrics distribution (v3.0).** New `POST /v3.0/api/tenants/{tenant_id}/monitor/distributions/{metric_name}` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v3.0/api/tenants/{tenant_id}/monitor/distributions/{metric_name}
  ```

- **Top N (v3.0).** New `POST /v3.0/api/tenants/{tenant_id}/monitor/topn` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v3.0/api/tenants/{tenant_id}/monitor/topn
  ```
...
- **Top N (v3.1).** New `POST /v3.1/api/tenants/{tenant_id}/monitor/topn` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v3.1/api/tenants/{tenant_id}/monitor/topn
  ```
...
- **Flows (v3.12).** New `POST /v3.12/api/tenants/{tenant_id}/monitor/flows` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v3.12/api/tenants/{tenant_id}/monitor/flows
  ```

- **Flows (v3.13).** New `POST /v3.13/api/tenants/{tenant_id}/monitor/flows` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v3.13/api/tenants/{tenant_id}/monitor/flows
  ```
...
- **EventsQueryAPI (v3.6).** New `POST /v3.6/api/tenants/{tenant_id}/events/query` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v3.6/api/tenants/{tenant_id}/events/query
  ```
...
- **EventsQueryAPI (v3.7).** New `POST /v3.7/api/tenants/{tenant_id}/events/query` endpoint now available.
  [Legacy API reference →](/sase/api/legacy)
  ```
  POST api.sase.paloaltonetworks.com/v3.7/api/tenants/{tenant_id}/events/query
  ```
