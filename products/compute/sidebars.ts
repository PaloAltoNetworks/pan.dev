...
module.exports = {
  ...
  compute_3403: [
    {
      type: "category",
      label: "Prisma Cloud Compute Edition - 34.03",
      collapsed: true,
      items: [
        "compute/api/34-03/compute-api-reference-home",
        "compute/api/34-03/access-api-self-hosted",
        "compute/api/34-03/set-up-console",
        "compute/api/34-03/stable-endpoints",
        require("./api/34-03/sidebar"),
      ],
    },
  ],
};
