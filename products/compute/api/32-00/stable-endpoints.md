...
All minor or maintainance versions (xx) of 32.xx release have n-2 support for backward compatibility. The documentation for the latest and other supported releases is available at:
