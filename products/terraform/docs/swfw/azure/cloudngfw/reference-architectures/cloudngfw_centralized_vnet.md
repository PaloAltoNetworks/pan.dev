...
sidebar_label: Cloud NGFW Centralized VNet
title: 'Reference Architecture with Terraform: Cloud NGFW in Azure, Virtual Network
  Design Model.'
---
...
[![GitHub Logo](/img/view_on_github.png)](https://github.com/PaloAltoNetworks/terraform-azurerm-swfw-modules/tree/main/examples/cloudngfw_centralized_vnet) [![Terraform Logo](/img/view_on_terraform_registry.png)](https://registry.terraform.io/modules/PaloAltoNetworks/swfw-modules/azurerm/latest/examples/cloudngfw_centralized_vnet)
...
![Azure NGFW hub README diagrams - Cloud NGFW_VNet](719d9281-c872-4945-9426-c7404cd620df.png)
