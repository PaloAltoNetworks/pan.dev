---
hide_title: true
id: cloudngfw_centralized_single_vwan
keywords:
- pan-os
- panos
- firewall
...
sidebar_label: Cloud NGFW Single Virtual WAN
title: 'Reference Architecture with Terraform: Cloud NGFW in Azure, Virtual WAN Design
  Model.'
---
...
[![GitHub Logo](/img/view_on_github.png)](https://github.com/PaloAltoNetworks/terraform-azurerm-swfw-modules/tree/main/examples/cloudngfw_centralized_single_vwan) [![Terraform Logo](/img/view_on_terraform_registry.png)](https://registry.terraform.io/modules/PaloAltoNetworks/swfw-modules/azurerm/latest/examples/cloudngfw_centralized_single_vwan)
...
![Azure NGFW hub README diagrams - Cloud NGFW_vWAN](1c6e3d51-cb3e-4d30-92c3-a96c9d60c652.png)
