...
In the first (Azure Rulestack managed) option, you create rules based on a matching criteria and leverage the Security Services straight from Azure Portal. 
...
- **Azure Portal** is a graphical user interface that provides native experience similar to any other Azure services.
- **Azure CLI/PowerShell/SDK/Terraform** can deploy Cloud NGFW resources programmatically in an Infrastructure-as-Code way.

For a description for the Cloud NGFW for Azure APIs, see the [API Reference](/cloudngfw/azure/api).
