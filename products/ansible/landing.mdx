...
If you are a user of the free and open-source Ansible offerings, you will still be able to use the collection of Ansible modules for PAN-OS as you always have done previously; the PAN-OS collection will continue to be published to [Ansible Galaxy](https://galaxy.ansible.com/ui/repo/published/paloaltonetworks/panos), as well as to Automation Hub, as viewable through [Ecosystem Catalog](https://catalog.redhat.com/software/collection/paloaltonetworks/panos?tab=overview).
