...
<div id="ansible_collections.paloaltonetworks.panos.panos_bgp_auth_module">
...
`Requirements <ansible_collections.paloaltonetworks.panos.panos_bgp_auth_module_requirements>`
for details.
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_bgp_auth_module__parameter-api_key">
<div className="rst-class">
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_bgp_auth_module__parameter-commit">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_bgp_auth_module__parameter-gathered_filter">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_bgp_auth_module__parameter-ip_address">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_bgp_auth_module__parameter-name">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<td><div className="ansible-option-cell">
<p>Name of Authentication Profile.</p>
</div></td>
</tr>
<tr className="even">
<td><div className="ansible-option-cell">
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_bgp_auth_module__parameter-password">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_bgp_auth_module__parameter-port">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_bgp_auth_module__parameter-provider">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_bgp_auth_module__parameter-provider/api_key">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_bgp_auth_module__parameter-provider/ip_address">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_bgp_auth_module__parameter-provider/password">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_bgp_auth_module__parameter-provider/port">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_bgp_auth_module__parameter-provider/serial_number">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_bgp_auth_module__parameter-provider/username">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<tr className="odd">
<td><div className="ansible-option-cell">
<div className="ansibleOptionAnchor" id="parameter-replace"></div>
<div
id="ansible_collections.paloaltonetworks.panos.panos_bgp_auth_module__parameter-replace">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
<p><strong>replace</strong></p>
<a className="ansibleOptionLink" href="#parameter-replace" title="Permalink to this option"></a>
<div className="rst-class">
<p>ansible-option-type-line</p>
</div>
<p><span className="ansible-option-type">boolean</span></p>
...
<td><div className="ansible-option-cell">
<p><strong>Deprecated</strong></p>
<p>This is the behavior of <em>state=present</em>, so this can safely be
removed from your playbooks.</p>
<hr/>
<p>The secret is encrypted so the state cannot be compared.</p>
<p>This option forces removal of a matching item before applying the new
config.</p>
<div className="rst-class">
<p>ansible-option-line</p>
</div>
...
<tr className="even">
<td><div className="ansible-option-cell">
<div className="ansibleOptionAnchor" id="parameter-secret"></div>
<div
id="ansible_collections.paloaltonetworks.panos.panos_bgp_auth_module__parameter-secret">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
<p><strong>secret</strong></p>
<a className="ansibleOptionLink" href="#parameter-secret" title="Permalink to this option"></a>
<div className="rst-class">
<p>ansible-option-type-line</p>
</div>
<p><span className="ansible-option-type">string</span></p>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_bgp_auth_module__parameter-state">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_bgp_auth_module__parameter-template">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_bgp_auth_module__parameter-template_stack">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_bgp_auth_module__parameter-username">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_bgp_auth_module__parameter-vr_name">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
\- Checkmode is not supported. - Panorama is supported. - Since the
*secret* value is encrypted in PAN-OS, there is no way to verify if the
secret is properly set or not. Invoking this module with *state=present*
will always apply the config to PAN-OS. - PAN-OS connectivity should be
specified using *provider* or the classic PAN-OS connectivity params
(*ip_address*, *username*, *password*, *api_key*, and *port*). If both
are present, then the classic params are ignored. - If the PAN-OS to be
configured is Panorama, either *template* or *template_stack* must be
specified.
