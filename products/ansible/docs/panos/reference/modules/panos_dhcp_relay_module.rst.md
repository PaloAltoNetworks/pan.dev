...
<div id="ansible_collections.paloaltonetworks.panos.panos_dhcp_relay_module">
...
`Requirements <ansible_collections.paloaltonetworks.panos.panos_dhcp_relay_module_requirements>`
for details.
...
- - Manage dhcp relay on PAN-OS firewall. - Due to the implementation
    details of PAN-OS itself, you can use this module to create a DHCP
    config without ever having to use
    `paloaltonetworks.panos.panos\_dhcp <ansible_collections.paloaltonetworks.panos.panos_dhcp_module>`
    first.
  - However, if you intend to delete an interface that was ever
    reference by this module, you will need to use
    `paloaltonetworks.panos.panos\_dhcp <ansible_collections.paloaltonetworks.panos.panos_dhcp_module>`
    to delete the parent reference or PAN-OS's internal validation
    checks will prevent the deletion, seeing that a DHCP config is
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_dhcp_relay_module__parameter-api_key">
<div className="rst-class">
...
<tr className="even">
<td><div className="ansible-option-cell">
<div className="ansibleOptionAnchor" id="parameter-dhcp_interface"></div>
<div
id="ansible_collections.paloaltonetworks.panos.panos_dhcp_relay_module__parameter-dhcp_interface">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
<p><strong>dhcp_interface</strong></p>
<a className="ansibleOptionLink" href="#parameter-dhcp_interface" title="Permalink to this option"></a>
<div className="rst-class">
<p>ansible-option-type-line</p>
</div>
...
<p>This is probably the same as <em>interface</em>.</p>
</div></td>
</tr>
<tr className="odd">
<td><div className="ansible-option-cell">
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_dhcp_relay_module__parameter-gathered_filter">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_dhcp_relay_module__parameter-interface">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<td><div className="ansible-option-cell">
<p>The interface name for the DHCP relay.</p>
<p>This is probably the same as the <em>dhcp_interface</em>.</p>
</div></td>
</tr>
<tr className="odd">
<td><div className="ansible-option-cell">
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_dhcp_relay_module__parameter-ip_address">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<tr className="even">
<td><div className="ansible-option-cell">
<div className="ansibleOptionAnchor" id="parameter-ipv4_enabled"></div>
<div
id="ansible_collections.paloaltonetworks.panos.panos_dhcp_relay_module__parameter-ipv4_enabled">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
<p><strong>ipv4_enabled</strong></p>
<a className="ansibleOptionLink" href="#parameter-ipv4_enabled" title="Permalink to this option"></a>
<div className="rst-class">
<p>ansible-option-type-line</p>
</div>
...
<tr className="odd">
<td><div className="ansible-option-cell">
<div className="ansibleOptionAnchor" id="parameter-ipv4_servers"></div>
<div
id="ansible_collections.paloaltonetworks.panos.panos_dhcp_relay_module__parameter-ipv4_servers">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
<p><strong>ipv4_servers</strong></p>
<a className="ansibleOptionLink" href="#parameter-ipv4_servers" title="Permalink to this option"></a>
<div className="rst-class">
<p>ansible-option-type-line</p>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_dhcp_relay_module__parameter-ipv6_enabled">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_dhcp_relay_module__parameter-password">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_dhcp_relay_module__parameter-port">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_dhcp_relay_module__parameter-provider">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_dhcp_relay_module__parameter-provider/api_key">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_dhcp_relay_module__parameter-provider/ip_address">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_dhcp_relay_module__parameter-provider/password">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_dhcp_relay_module__parameter-provider/port">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_dhcp_relay_module__parameter-provider/serial_number">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_dhcp_relay_module__parameter-provider/username">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_dhcp_relay_module__parameter-state">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_dhcp_relay_module__parameter-username">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
\- Check mode is supported. - Panorama is not supported. - PAN-OS
