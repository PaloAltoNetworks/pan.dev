...
<div id="ansible_collections.paloaltonetworks.panos.panos_op_module">
...
`Requirements <ansible_collections.paloaltonetworks.panos.panos_op_module_requirements>`
for details.
...
- This module will allow user to pass and execute any supported OP
  command on the PANW device.
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_op_module__parameter-api_key">
<div className="rst-class">
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_op_module__parameter-cmd">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<td><div className="ansible-option-cell">
<p>The OP command to be performed.</p>
</div></td>
</tr>
<tr className="odd">
<td><div className="ansible-option-cell">
<div className="ansibleOptionAnchor" id="parameter-cmd_is_xml"></div>
<div
id="ansible_collections.paloaltonetworks.panos.panos_op_module__parameter-cmd_is_xml">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
<p><strong>cmd_is_xml</strong></p>
<a className="ansibleOptionLink" href="#parameter-cmd_is_xml" title="Permalink to this option"></a>
<div className="rst-class">
<p>ansible-option-type-line</p>
</div>
...
<td><div className="ansible-option-cell">
<p>The cmd is already given in XML format, so don't convert it.</p>
<div className="rst-class">
...
<tr className="even">
<td><div className="ansible-option-cell">
<div className="ansibleOptionAnchor" id="parameter-ignore_disconnect"></div>
<div
id="ansible_collections.paloaltonetworks.panos.panos_op_module__parameter-ignore_disconnect">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
<p><strong>ignore_disconnect</strong></p>
<a className="ansibleOptionLink" href="#parameter-ignore_disconnect" title="Permalink to this option"></a>
<div className="rst-class">
<p>ansible-option-type-line</p>
</div>
<p><span className="ansible-option-type">boolean</span></p>
...
<td><div className="ansible-option-cell">
<p>Some op commands disconnect the client before returning a
response.</p>
<p>Enable this to prevent this module from erroring out if the command
could cause this.</p>
<p>If running such a command, you can use <code className="interpreted-text"
role="ref">paloaltonetworks.panos.panos\_check &lt;ansible_collections.paloaltonetworks.panos.panos_check_module&gt;</code>
to wait for PAN-OS to be accessible.</p>
<div className="rst-class">
<p>ansible-option-line</p>
</div>
<p><span className="ansible-option-choices">Choices:</span></p>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_op_module__parameter-ip_address">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_op_module__parameter-password">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_op_module__parameter-port">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_op_module__parameter-provider">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_op_module__parameter-provider/api_key">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_op_module__parameter-provider/ip_address">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_op_module__parameter-provider/password">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_op_module__parameter-provider/port">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_op_module__parameter-provider/serial_number">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_op_module__parameter-provider/username">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_op_module__parameter-username">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_op_module__parameter-vsys">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<td><div className="ansible-option-cell">
<p>The vsys target where the OP command will be performed.</p>
<div className="rst-class">
<p>ansible-option-line</p>
</div>
<p><span className="ansible-option-default-bold">Default:</span> <code
...
<tr className="odd">
<td><div className="ansible-option-cell">
<div className="ansibleOptionAnchor" id="return-disconnected"></div>
<div
id="ansible_collections.paloaltonetworks.panos.panos_op_module__return-disconnected">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
<p><strong>disconnected</strong></p>
<a className="ansibleOptionLink" href="#return-disconnected" title="Permalink to this return value"></a>
<div className="rst-class">
<p>ansible-option-type-line</p>
</div>
<p><span className="ansible-option-type">boolean</span></p>
...
<td><div className="ansible-option-cell">
<p>If a disconnect was ignored or not.</p>
<div className="rst-class">
<p>ansible-option-line</p>
</div>
...
className="interpreted-text" role="ansible-rv-sample-value">true</code></p>
</div></td>
</tr>
<tr className="even">
<td><div className="ansible-option-cell">
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_op_module__return-stdout">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<td><div className="ansible-option-cell">
<p>output of the given OP command as JSON formatted string</p>
<div className="rst-class">
<p>ansible-option-line</p>
</div>
<p><span className="ansible-option-returned-bold">Returned:</span>
...
<div
id="ansible_collections.paloaltonetworks.panos.panos_op_module__return-stdout_xml">
<div className="rst-class">
<p>ansible-option-title</p>
</div>
</div>
...
<td><div className="ansible-option-cell">
<p>output of the given OP command as an XML formatted string</p>
<div className="rst-class">
<p>ansible-option-line</p>
</div>
<p><span className="ansible-option-returned-bold">Returned:</span>
...
<p><span className="ansible-option-sample-bold">Sample:</span> <code
className="interpreted-text"
role="ansible-rv-sample-value">"\&lt;response status=success\&gt;\&lt;result\&gt;\&lt;system\&gt;\&lt;hostname\&gt;fw2\&lt;/hostname\&gt;"</code></p>
</div></td>
</tr>
</tbody>
</table>
