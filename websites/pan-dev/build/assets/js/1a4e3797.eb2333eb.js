/*! For license information please see 1a4e3797.eb2333eb.js.LICENSE.txt */
(self.webpackChunkpan_dev = self.webpackChunkpan_dev || []).push([
  [138],
  {
      ...
      (e.exports = i),
        ...
        (i.prototype.addListener = function (e, t) {
          ...
          return (
            ...
            a(this._events[e]) &&
              ...
              "function" == typeof n.trace && n.trace()),
            this
          );
        }),
        ...
        (i.prototype.removeListener = function (e, t) {
          ...
          if (
            ...
            (n = -1),
            r === t || (s(r.listener) && r.listener === t))
          )
            delete this._events[e],
              this._events.removeListener && this.emit("removeListener", e, t);
          else if (a(r)) {
            for (c = i; c-- > 0; )
              if (r[c] === t || (r[c].listener && r[c].listener === t)) {
                n = c;
                break;
              }
            if (n < 0) return this;
    ...
    52256: (e, t, r) => {
      ...
      (o.version = r(82153)),
        (o.AlgoliaSearchHelper = n),
        (o.SearchParameters = a),
        (o.RecommendParameters = i),
        (o.SearchResults = c),
        (o.RecommendResults = s),
        (e.exports = o);
    },
    22255: (e, t, r) => {
      "use strict";
      ...
      (t.prototype = {
        ...
        addFrequentlyBoughtTogether: function (e) {
          return this.addParams(
            Object.assign({}, e, { model: "bought-together" })
          );
        },
        ...
        addTrendingItems: function (e) {
          return this.addParams(
            Object.assign({}, e, { model: "trending-items" })
          );
        },
        addTrendingFacets: function (e) {
          return this.addParams(
            Object.assign({}, e, { model: "trending-facets" })
          );
        },
        addLookingSimilar: function (e) {
          return this.addParams(
            Object.assign({}, e, { model: "looking-similar" })
          );
        },
      ...
      var n = r(79387),
        ...
        a = {
          ...
          toggleRefinement: function (e, t, r) {
            ...
            return a.isRefined(e, t, r)
              ? a.removeRefinement(e, t, r)
              : a.addRefinement(e, t, r);
          },
      ...
      (d.PARAMETERS = Object.keys(new d())),
        ...
        (d.prototype = {
          ...
          _clearNumericRefinements: function (e) {
            if (void 0 === e)
              return o(this.numericRefinements) ? {} : this.numericRefinements;
          ...
          isNumericRefined: function (e, t, r) {
            if (void 0 === r && void 0 === t)
              return Boolean(this.numericRefinements[e]);
            var n =
      ...
      e.exports = function (e) {
        return function (t, r) {
          var n = e.hierarchicalFacets[r],
            u =
              (e.hierarchicalFacetsRefinements[n.name] &&
                e.hierarchicalFacetsRefinements[n.name][0]) ||
              "",
                    ...
                    .filter(function (e) {
                      return (function (e, t, r, n, i, s) {
                        ...
                        return (
                          ...
                          0 === r.indexOf(e) ||
                          (0 === e.indexOf(t + n) && (s || 0 === e.indexOf(r)))
                        );
    ...
    71568: (e, t, r) => {
      ...
      function g(e, t, r) {
        ...
        var h = u({ persistHierarchicalRootCount: !1 }, r);
        ...
        Object.keys(R).forEach(function (t) {
          ...
          if (u) {
            ...
            m &&
              ((l = v[t]),
              (o.disjunctiveFacets[l] = {
                name: t,
                data: i,
                exhaustive: s.exhaustiveFacetsCount,
              }),
              p(o.disjunctiveFacets[l], s.facets_stats, t)),
              d &&
                ((l = g[t]),
                (o.facets[l] = {
                  name: t,
          ...
          f.forEach(function (r) {
            ...
            Object.keys(a).forEach(function (t) {
              ...
              if (h) {
                ...
                var m = c(o.hierarchicalFacets[r], function (e) {
                  return e.attribute === t;
                });
                if (-1 === m) return;
                o.hierarchicalFacets[r][m].data = u(
                  {},
                  o.hierarchicalFacets[r][m].data,
                  f
                );
              } else {
                r = v[t];
                ...
                (o.disjunctiveFacets[r] = {
                  ...
                  p(o.disjunctiveFacets[r], n.facets_stats, t),
                  e.disjunctiveFacetsRefinements[t] &&
                    e.disjunctiveFacetsRefinements[t].forEach(function (n) {
                      !o.disjunctiveFacets[r].data[n] &&
                        e.disjunctiveFacetsRefinements[t].indexOf(l(n)) > -1 &&
                        (o.disjunctiveFacets[r].data[n] = 0);
                    });
              }
            }),
              y++;
              ...
              t.slice(y).forEach(function (t) {
                ...
                Object.keys(r).forEach(function (t) {
                  var u = r[t],
                    ...
                    f = c(o.hierarchicalFacets[h], function (e) {
                      return e.attribute === t;
                    });
                  if (-1 !== f) {
                    var l = {};
                    if (a.length > 0 && !o.persistHierarchicalRootCount) {
                      var m = a[0].split(s)[0];
                      l[m] = o.hierarchicalFacets[h][f].data[m];
                    }
                    o.hierarchicalFacets[h][f].data = i(
                      l,
                      u,
                      o.hierarchicalFacets[h][f].data
                    );
                  }
                }),
                  y++;
          ...
          Object.keys(e.facetsExcludes).forEach(function (t) {
            ...
            (o.facets[n] = {
              ...
              r.forEach(function (e) {
                (o.facets[n] = o.facets[n] || { name: t }),
                  (o.facets[n].data = o.facets[n].data || {}),
                  (o.facets[n].data[e] = 0);
              });
          }),
      ...
      function v(e, t) {
        ...
        if (e._state.isHierarchicalFacet(t)) {
          ...
          var c = e._state.getHierarchicalFacetByName(t),
            o = e._state._getHierarchicalFacetSeparator(c),
            u = l(e._state.getHierarchicalRefinement(t)[0] || "");
          0 === u.indexOf(c.rootPath) && (u = u.replace(c.rootPath + o, ""));
          var h = u.split(o);
          return h.unshift(t), y(s, h, 0), s;
        }
      }
      function y(e, t, r) {
        (e.isRefined = e.name === (t[r] && t[r].trim())),
          e.data &&
      ...
      function b(e, t, r, n, i) {
        var s = a(i, function (e) {
          ...
          o = (s && s.exhaustive) || !1;
        return { type: t, attributeName: r, name: n, count: c, exhaustive: o };
      }
      (g.prototype.getFacetByName = function (e) {
        ...
        return (
          a(this.facets, t) ||
          a(this.disjunctiveFacets, t) ||
          a(this.hierarchicalFacets, t)
        );
      }),
                  ...
                  if (r)
                    return (function (e, t) {
                      var r = [],
                        n = [],
                        i = t.hide || [],
                        s = (t.order || []).reduce(function (e, t, r) {
                          return (e[t] = r), e;
                        }, {});
                      e.forEach(function (e) {
                        var t = e.path || e.name,
                          a = i.indexOf(t) > -1;
                        a || void 0 === s[t] ? a || n.push(e) : (r[s[t]] = e);
                      }),
                      ...
                      return "hidden" === c
                        ...
                        : ((a =
                            "alpha" === c
                              ...
                              : [["count"], ["desc"]]),
                          r.concat(h(n, a[0], a[1])));
                    })(e, r);
                }
                if (Array.isArray(s.sortBy)) {
                  var n = o(s.sortBy, g.DEFAULT_SORT);
                  return h(e, n[0], n[1]);
                }
    ...
    13502: (e, t, r) => {
      ...
      function y(e, t, r, n) {
        "function" == typeof e.addAlgoliaAgent &&
          e.addAlgoliaAgent("JS Helper (" + v + ")"),
          this.setClient(e);
        var i = r || {};
        (i.index = t),
          (this.state = d.make(i)),
          (this.recommendState = new f({ params: i.recommendState })),
          (this.lastResults = null),
          (this.lastRecommendResults = null),
          (this._queryId = 0),
      ...
      c(y, i),
        ...
        (y.prototype.findAnswers = function (e) {
          n.warn("[algoliasearch-helper] answers is no longer supported");
          var t = this.state,
            r = this.derivedHelpers[0];
          if (!r) return Promise.resolve([]);
          var i = r.getModifiedState(t),
            s = o(
              {
              ...
              {
                params: h(m._getHitsSearchParams(i), [
                  "attributesToSnippet",
                  "hitsPerPage",
          ...
          var c = this.client.initIndex(i.index);
          if ("function" != typeof c.findAnswers) throw new Error(a);
          return c.findAnswers(i.query, e.queryLanguages, s);
        }),
        (y.prototype.searchForFacetValues = function (e, t, r, n) {
          ...
          if (!i && !s && "function" != typeof this.client.search)
            throw new Error(
              "search for facet values (searchable) was called, but this client does not have a function client.searchForFacetValues or client.initIndex(index).searchForFacetValues"
            );
          var c = this.state.setQueryParameters(n || {}),
            o = c.isDisjunctiveFacet(e),
            u = m.getSearchForFacetQuery(e, t, r, c);
          this._currentNbQueries++;
          var h,
            f = this;
          return (
            i
              ? (h = this.client.searchForFacetValues([
                  { indexName: c.index, params: u },
                ]))
              : s
              ? (h = this.client.initIndex(c.index).searchForFacetValues(u))
              : (delete u.facetName,
                (h = this.client
                  .search([
                    { type: "facet", facet: e, indexName: c.index, params: u },
                  ])
                  .then(function (e) {
                    return e.results[0];
                  }))),
        ...
        (y.prototype.setCurrentPage = R),
        (y.prototype.setPage = R),
        ...
        (y.prototype.getCurrentPage = F),
        (y.prototype.getPage = F),
        ...
        (y.prototype._search = function (e) {
          ...
          var i = this.derivedHelpers.map(function (e) {
              var n = e.getModifiedState(t),
                i = n.index ? m._getQueries(n.index, n) : [];
              return (
            ...
            a = this._queryId++;
          if ((this._currentNbQueries++, !s.length))
            return Promise.resolve({ results: [] }).then(
              this._dispatchAlgoliaResponse.bind(this, r, a)
            );
          try {
            this.client
              .search(s)
        ...
        (y.prototype._recommend = function () {
          var e = this.state,
            ...
            r = this.getIndex(),
            i = [{ state: t, index: r, helper: this }],
            s = t.params.map(function (e) {
              return e.$$id;
            });
          this.emit("fetch", {
            recommend: { state: t, results: this.lastRecommendResults },
          });
          var a = this._recommendCache,
            c = this.derivedHelpers.map(function (t) {
              var r = t.getModifiedState(e).index;
              if (!r) return [];
              var n = t.getModifiedRecommendState(new f());
              return (
                i.push({ state: n, index: r, helper: t }),
                ...
                t.emit("fetch", {
                  recommend: { state: n, results: t.lastRecommendResults },
                }),
                n._buildQueries(r, a)
              );
            }),
          ...
          if (0 !== o.length)
            if (o.length > 0 && void 0 === this.client.getRecommendations)
              n.warn(
              ...
              try {
                this.client
                  ...
                  .then(this._dispatchRecommendResponse.bind(this, u, i, s))
                  .catch(this._dispatchRecommendError.bind(this, u));
              } catch (h) {
                this.emit("error", { error: h });
              }
            }
        }),
          ...
          if (!(t < this._lastQueryIdReceived)) {
            ...
            e.forEach(function (e) {
              var t = e.state,
                ...
                a = i.splice(0, r);
              t.index
                ? ((s.lastResults = new p(t, a, n._searchResultsOptions)),
                  s.emit("result", { results: s.lastResults, state: t }))
                : s.emit("result", { results: null, state: t });
            });
          }
        }),
            ...
            r.forEach(function (e) {
              ...
              t.forEach(function (e) {
                var t = e.state,
                  r = e.helper;
                e.index
                  ? ((r.lastRecommendResults = new l(t, a)),
                    r.emit("recommend:result", {
                      recommend: { results: r.lastRecommendResults, state: t },
                    }))
                  : r.emit("recommend:result", { results: null, state: t });
              });
          }
        }),
      ...
      var s = {
        _getQueries: function (e, t) {
          ...
          return (
            ...
            t.getRefinedDisjunctiveFacets().forEach(function (n) {
              r.push({
                indexName: e,
                params: s._getDisjunctiveFacetSearchParams(t, n),
              });
            }),
            t.getRefinedHierarchicalFacets().forEach(function (n) {
              ...
              if (a.length > 0 && a[0].split(c).length > 1) {
                ...
                o.forEach(function (n, a) {
                  var c = s._getDisjunctiveFacetSearchParams(
                    t,
                    n.attribute,
                    0 === a
                  );
                  ...
                  var h = (c.facetFilters || []).reduce(function (e, t) {
                    ...
                    f = o[a - 1];
                  a > 0
                    ? (c.facetFilters = h.concat(f.attribute + ":" + f.value))
                    : h.length > 0
                    ? (c.facetFilters = h)
                    : delete c.facetFilters,
                    r.push({ indexName: e, params: c });
                });
              }
            }),
            r
        ...
        _getHitsSearchParams: function (e) {
          var t = e.facets
              ...
              .concat(s._getHitsHierarchicalFacetsAttributes(e))
              .sort(),
            ...
            o = {};
          return (
            t.length > 0 && (o.facets = t.indexOf("*") > -1 ? ["*"] : t),
            c.length > 0 && (o.tagFilters = c),
            r.length > 0 && (o.facetFilters = r),
            a.length > 0 && (o.numericFilters = a),
        ...
        _getDisjunctiveFacetSearchParams: function (e, t, r) {
          var a = s._getFacetFilters(e, t, r),
            ...
            o = s._getTagFilters(e),
            u = { hitsPerPage: 0, page: 0, analytics: !1, clickAnalytics: !1 };
          o.length > 0 && (u.tagFilters = o);
          var h = e.getHierarchicalFacetByName(t);
          return (
            (u.facets = h
              ? s._getDisjunctiveHierarchicalFacetAttribute(e, h, r)
              : t),
            c.length > 0 && (u.numericFilters = c),
            a.length > 0 && (u.facetFilters = a),
              ...
              .forEach(function (i) {
                ...
                if (void 0 !== s) {
                  var a,
                    ...
                    h = e._getHierarchicalFacetSeparator(u),
                    f = e._getHierarchicalRootPath(u);
                  if (t === i) {
                    if (
                      -1 === s.indexOf(h) ||
                      (!f && !0 === r) ||
                      (f && f.split(h).length === s.split(h).length)
                    )
                      return;
                    f
                      ? ((o = f.split(h).length - 1), (s = f))
                      : ((o = s.split(h).length - 2),
                        (s = s.slice(0, s.lastIndexOf(h)))),
                      (a = u.attributes[o]);
                  } else (o = s.split(h).length - 1), (a = u.attributes[o]);
                  a && n.push([a + ":" + s]);
                }
              }),
            n
        ...
        getSearchForFacetQuery: function (e, t, r, a) {
          ...
          return (
            ...
            i(n({}, s._getHitsSearchParams(c), o))
          );
        },
      };
      e.exports = s;
        ...
        return (
          e.forEach(function (e) {
            e.forEach(function (e, r) {
              t[e.objectID]
                ? (t[e.objectID] = {
                    indexSum: t[e.objectID].indexSum + r,
                    count: t[e.objectID].count + 1,
                  })
                : (t[e.objectID] = { indexSum: r, count: 1 });
            });
          }),
          (function (e, t) {
            var r = [];
            return (
              Object.keys(e).forEach(function (n) {
                e[n].count < 2 && (e[n].indexSum += 100),
                  r.push({ objectID: n, avgOfIndices: e[n].indexSum / t });
              }),
              r.sort(function (e, t) {
                return e.avgOfIndices > t.avgOfIndices ? 1 : -1;
              })
            );
          })(t, e.length).reduce(function (t, r) {
            var s = n(i(e), function (e) {
              return e.objectID === r.objectID;
            });
            return s ? t.concat(s) : t;
          }, [])
        );
      };
    },
      ...
      e.exports = (function () {
            ...
            : {
                get: function (e, n) {
                  ...
                  return r.get(e, n, i).catch(function () {
                    return o({ caches: t }).get(e, n, i);
                  });
                },
                set: function (e, n) {
                  return r.set(e, n).catch(function () {
                    return o({ caches: t }).set(e, n);
                  });
                },
                delete: function (e) {
        ...
        function P(e, t, n, i) {
          var s = [],
            ...
            u = n.method,
            h = n.method !== b ? {} : r(r({}, n.data), i.data),
            f = r(
              r(
                  ...
                  onRetry: function (n) {
                    ...
                    return (
                      ...
                      Promise.all([
                        ...
                        e.hostsCache.set(h, R(h, n.isTimedOut ? y : v)),
                      ]).then(function () {
                        return t(r, a);
                      })
                    );
          ...
          return _(e.hostsCache, t).then(function (e) {
                  ...
                  f = {
                    ...
                    read: function (e, t) {
                      ...
                      return f.responsesCache.get(
                        ...
                        {
                          miss: function (e) {
                            return f.responsesCache.set(i, e);
                          },
                        }
                      );
                    },
          ...
          Q = function (e) {
            return function (t, n) {
              var i = t.map(function (e) {
                return r(r({}, e), {}, { params: O(e.params || {}) });
              });
              ...
              return Promise.all(
                t.map(function (t) {
                  var s = t.params,
                    a = s.facetName,
                    c = s.facetQuery,
                    o = i(s, ["facetName", "facetQuery"]);
                  return H(e)(t.indexName, {
                    methods: { searchForFacetValues: D },
                  }).searchForFacetValues(a, c, r(r({}, n), o));
                })
              );
            };
          },
          C = function (e) {
            return function (t, r, n) {
              return e.transporter.read(
                {
                  method: j,
                  path: l("1/answers/%s/prediction", e.indexName),
          ...
          I = function (e) {
            return function (t, r) {
              return e.transporter.read(
                {
                  method: j,
                  path: l("1/indexes/%s/query", e.indexName),
                  data: { query: t },
                  cacheable: !0,
                },
                r
          ...
          var s,
            a = {
              ...
              logger:
                ...
                {
                  debug: function (e, t) {
                    return k >= s && n.debug(e, t), Promise.resolve();
                  },
                  info: function (e, t) {
                    return q >= s && n.info(e, t), Promise.resolve();
                  },
                  error: function (e, t) {
              ...
              hostsCache: o({
                caches: [c({ key: "".concat("4.24.0", "-").concat(e) }), u()],
              }),
              userAgent: x("4.24.0").add({
                segment: "Browser",
                version: "lite",
              }),
    ...
    90727: (e, t, r) => {
      ...
      var n = r(14041),
        i = r(28512),
        s = r(4364);
      const a = ["zero", "one", "two", "few", "many", "other"];
      function c(e) {
        ...
        return (0, n.useMemo)(() => {
          try {
            return (function (e) {
              ...
              return {
                locale: e,
                pluralForms: c(t.resolvedOptions().pluralCategories),
                select: (e) => t.select(e),
              };
            })(e);
          } catch (t) {
        ...
        return {
          selectMessage: (t, r) =>
            (function (e, t, r) {
              ...
              n.length > r.pluralForms.length &&
                s.error(
                  `For locale=${r.locale}, a maximum of ${
    ...
    34e3: (e, t, r) => {
      ...
      var n = r(31085),
        ...
        _ = r(28407);
      const P = {
        searchQueryInput: "searchQueryInput_mqxW",
        searchVersionInput: "searchVersionInput_HEI2",
        searchResultsColumn: "searchResultsColumn_mUtW",
        algoliaLogo: "algoliaLogo_UZcB",
        algoliaLogoPathFill: "algoliaLogoPathFill_e2la",
        searchResultItem: "searchResultItem_xxKp",
        searchResultItemHeading: "searchResultItemHeading_PVtz",
        searchResultItemPath: "searchResultItemPath_a5rs",
        searchResultItemSummary: "searchResultItemSummary_kckr",
        searchQueryColumn: "searchQueryColumn_UwEn",
        searchVersionColumn: "searchVersionColumn__uPC",
        searchLogoColumn: "searchLogoColumn_LvDb",
        loadingSpinner: "loadingSpinner_jtAn",
        "loading-spin": "loading-spin_zPLR",
        loader: "loader_je00",
      };
      function x({ docsSearchVersionsHelpers: e }) {
        const t = Object.entries(e.allDocsData).filter(
          ([, e]) => e.versions.length > 1
        );
        return (0, n.jsx)("div", {
          ...
          children: t.map(([r, i]) => {
            ...
            return (0, n.jsx)(
              "select",
              {
                onChange: (t) => e.setSearchVersion(r, t.target.value),
                defaultValue: e.searchVersions[r],
                className: P.searchVersionInput,
                children: i.versions.map((e, t) =>
                  (0, n.jsx)(
                    "option",
                    { label: `${s}${e.label}`, value: e.name },
                    t
                  )
                ),
              },
      ...
      function E() {
        const {
          ...
          {
            algolia: { appId: t, apiKey: r, indexName: a },
          } = (0, b.c)(),
          o = (0, j.C)(),
          v = (function () {
            const { selectMessage: e } = (0, d.W)();
            return (t) =>
              e(
                t,
                (0, R.T)(
            ...
            const e = (0, m.Gy)(),
              [t, r] = (0, i.useState)(() =>
                Object.entries(e).reduce(
                  (e, [t, r]) => ({ ...e, [t]: r.versions[0].name }),
                  {}
                )
              ),
              n = Object.values(e).some((e) => e.versions.length > 1);
            return {
              allDocsData: e,
              versioningEnabled: n,
              searchVersions: t,
              setSearchVersion: (e, t) => r((r) => ({ ...r, [e]: t })),
            };
          })(),
          [O, w] = (0, p.b)(),
          S = {
                ...
                return O !== t.value.query
                  ...
                  : {
                      ...
                      items:
                        0 === t.value.lastPage
                          ? t.value.items
                          : e.items.concat(t.value.items),
                    };
              case "advance": {
                const t = e.totalPages > e.lastPage + 1;
                return {
                  ...e,
                  lastPage: t ? e.lastPage + 1 : e.lastPage,
                  hasMore: t,
                };
              }
              default:
        ...
        Q.on(
          "result",
          ({
            results: { query: e, hits: t, page: r, nbHits: n, nbPages: i },
          }) => {
            if ("" === e || !Array.isArray(t)) return void A({ type: "reset" });
            const s = (e) =>
                e.replace(
              ...
              a = t.map(
                ({
                  url: e,
                  _highlightResult: { hierarchy: t },
                  _snippetResult: r = {},
                }) => {
                  const n = Object.keys(t).map((e) => s(t[e].value));
                  return {
                    title: n.pop(),
                    url: o(e),
                    summary: r.content ? `${s(r.content.value)}...` : "",
                    breadcrumbs: n,
                  };
                }
              );
        ...
        const [T, C] = (0, i.useState)(null),
          I = (0, i.useRef)(0),
          D = (0, i.useRef)(
            h.default.canUseIntersectionObserver &&
              new IntersectionObserver(
                (e) => {
                  ...
                  t && I.current > r && A({ type: "advance" }), (I.current = r);
                },
                { threshold: 1 }
              )
          ),
          ...
          q = (0, g._q)((t = 0) => {
            Q.addDisjunctiveFacetRefinement("docusaurus_tag", "default"),
              ...
              Object.entries(E.searchVersions).forEach(([e, t]) => {
                Q.addDisjunctiveFacetRefinement(
                  "docusaurus_tag",
                  `docs-${e}-${t}`
                );
              }),
              Q.setQuery(O).setPage(t).search();
          });
        return (
          (0, i.useEffect)(() => {
            if (!T) return;
            const e = D.current;
            return e ? (e.observe(T), () => e.unobserve(T)) : () => !0;
          }, [T]),
          (0, i.useEffect)(() => {
            A({ type: "reset" }),
              O &&
          ...
          }, [O, E.searchVersions, q]),
          (0, i.useEffect)(() => {
            N.lastPage && 0 !== N.lastPage && q(N.lastPage);
          }, [q, N.lastPage]),
          (0, n.jsxs)(_.A, {
            children: [
              (0, n.jsxs)(f.A, {
                children: [
                  (0, n.jsx)("title", { children: (0, y.s)(k()) }),
                  (0, n.jsx)("meta", {
                    property: "robots",
              ...
              (0, n.jsxs)("div", {
                ...
                children: [
                  (0, n.jsx)("h1", { children: k() }),
                  (0, n.jsxs)("form", {
                    className: "row",
                    onSubmit: (e) => e.preventDefault(),
                    children: [
                      (0, n.jsx)("div", {
                        className: (0, s.default)("col", P.searchQueryColumn, {
                          "col--9": E.versioningEnabled,
                          "col--12": !E.versioningEnabled,
                        }),
                        children: (0, n.jsx)("input", {
                          type: "search",
                          name: "q",
                          className: P.searchQueryInput,
                          placeholder: (0, R.T)({
                      ...
                      E.versioningEnabled &&
                        (0, n.jsx)(x, { docsSearchVersionsHelpers: E }),
                    ],
                  }),
                  (0, n.jsxs)("div", {
                    className: "row",
                    children: [
                      (0, n.jsx)("div", {
                        className: (0, s.default)(
                          "col",
                          "col--8",
                          P.searchResultsColumn
                        ),
                        children: !!N.totalResults && v(N.totalResults),
                      }),
                      (0, n.jsx)("div", {
                        className: (0, s.default)(
                          "col",
                        ...
                        children: (0, n.jsx)("a", {
                          ...
                          children: (0, n.jsx)("svg", {
                            viewBox: "0 0 168 24",
                            className: P.algoliaLogo,
                            children: (0, n.jsxs)("g", {
                              fill: "none",
                              children: [
                                (0, n.jsx)("path", {
                                  className: P.algoliaLogoPathFill,
                  ...
                  N.items.length > 0
                    ? (0, n.jsx)("main", {
                        children: N.items.map(
                          (
                            { title: e, url: t, summary: r, breadcrumbs: i },
                            a
                          ) =>
                            (0, n.jsxs)(
                              "article",
                              {
                                className: P.searchResultItem,
                                children: [
                                  (0, n.jsx)("h2", {
                                    className: P.searchResultItemHeading,
                                  ...
                                  r &&
                                    (0, n.jsx)("p", {
                                      className: P.searchResultItemSummary,
