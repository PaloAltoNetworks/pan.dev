  ...
  [781],
  {
    41781: (t, e, n) => {
        ...
        c =
          ...
          (function () {
            var t = function (t, e, n, i) {
              ...
              e = [1, 2],
              n = [1, 5],
              i = [6, 9, 11, 17, 18, 20, 22, 23, 26, 27, 28],
              s = [1, 15],
              r = [1, 16],
              a = [1, 17],
              o = [1, 18],
              ...
              h = [1, 24],
              d = [1, 27],
              u = [4, 6, 9, 11, 17, 18, 20, 22, 23, 26, 27, 28],
              p = {
                trace: function () {},
                yy: {},
                symbols_: {
                ...
                performAction: function (t, e, n, i, s, r, a) {
                  var o = r.length - 1;
                  switch (s) {
                    case 1:
                      return r[o - 1];
                    ...
                    case 6:
                      ...
                      break;
                    case 11:
                      i.getCommonDb().setDiagramTitle(r[o].substr(6)),
                        (this.$ = r[o].substr(6));
                      break;
                    case 12:
                      (this.$ = r[o].trim()),
                        i.getCommonDb().setAccTitle(this.$);
                      break;
                    case 13:
                    case 14:
                      (this.$ = r[o].trim()),
                        i.getCommonDb().setAccDescription(this.$);
                      break;
                    case 15:
                    ...
                    case 21:
                      ...
                      break;
                    case 22:
                      i.parseDirective(r[o], "type_directive");
                      break;
                    case 23:
                      (r[o] = r[o].trim().replace(/'/g, '"')),
                        i.parseDirective(r[o], "arg_directive");
                      break;
                    case 24:
                      i.parseDirective("}%%", "close_directive", "timeline");
                  }
                },
                table: [
                  { 3: 1, 4: e, 7: 3, 12: 4, 28: n },
                  { 1: [3] },
                  t(i, [2, 3], { 5: 6 }),
                  { 3: 7, 4: e, 7: 3, 12: 4, 28: n },
                  { 13: 8, 29: [1, 9] },
                  { 29: [2, 21] },
                  {
                    6: [1, 10],
                ...
                parse: function (t) {
                  ...
                  for (var f, m, _, b, v, k, x, S, w, $ = {}; ; ) {
                    if (
                      ((m = n[n.length - 1]),
                      this.defaultActions[m]
                        ? (_ = this.defaultActions[m])
                        : (null == f &&
                            ((w = void 0),
                            "number" != typeof (w = i.pop() || d.lex() || 1) &&
                              (w instanceof Array && (w = (i = w).pop()),
                              (w = e.symbols_[w] || w)),
                            (f = w)),
                          (_ = a[m] && a[m][f])),
              ...
              y = {
                ...
                conditions: {
                  ...
                  INITIAL: {
                    rules: [
                      0, 5, 6, 7, 8, 9, 10, 11, 12, 14, 16, 19, 20, 21, 22, 23,
                    ],
                    inclusive: !0,
                  },
                },
            ...
            return (p.lexer = y), (g.prototype = p), (p.Parser = g), new g();
          })());
      c.parser = c;
      const l = c;
      let h = "",
      ...
      const u = [],
        ...
        g = () => i.j,
        f = (t, e, n) => {
          (0, i.k)(globalThis, t, e, n);
        },
        m = function () {
          (u.length = 0), (p.length = 0), (h = ""), (y.length = 0), (0, i.m)();
        },
        _ = function (t) {
          (h = t), u.push(t);
        },
        ...
        x = function (t) {
          y.find((t) => t.id === d - 1).events.push(t);
        },
        S = function (t) {
          const e = {
            section: h,
        ...
        t.each(function () {
          ...
          for (let s = 0; s < i.length; s++)
            (t = i[i.length - 1 - s]),
              r.push(t),
              c.text(r.join(" ").trim()),
              (c.node().getComputedTextLength() > e || "<br>" === t) &&
                (r.pop(),
                c.text(r.join(" ").trim()),
                (r = "<br>" === t ? [""] : [t]),
                (c = n
      ...
      const I = function (t, e, n) {
          t
            ...
            .attr(
              "d",
              `M0 ${e.height - 5} v${10 - e.height} q0,-5 5,-5 h${
                e.width - 10
              } q5,0 5,5 v${e.height - 5} H0 Z`
            ),
            t
              .append("line")
        ...
        T = function (t, e, n, i) {
          ...
          (e.section = s),
            r.attr(
              "class",
              (e.class ? e.class + " " : "") + "timeline-node section-" + s
            );
          const a = r.append("g"),
            o = r.append("g"),
            c = o
              ...
              .getBBox(),
            l =
              i.fontSize && i.fontSize.replace
                ? i.fontSize.replace("px", "")
                : i.fontSize;
          return (
            (e.height = c.height + 1.1 * l * 0.5 + e.padding),
            (e.height = Math.max(e.height, e.maxHeight)),
            (e.width = e.width + 2 * e.padding),
            o.attr(
              "transform",
              "translate(" + e.width / 2 + ", " + e.padding / 2 + ")"
            ),
            I(a, e, s),
            e
          );
        ...
        D = function (t, e, n) {
          const i = t.append("g"),
            s = i
              ...
              .getBBox(),
            r =
              n.fontSize && n.fontSize.replace
                ? n.fontSize.replace("px", "")
                : n.fontSize;
          return i.remove(), s.height + 1.1 * r * 0.5 + e.padding;
        },
        C = function (t, e, n, s, r, a, o, c, l, h, d) {
          for (const u of e) {
            const e = {
              descr: u.task,
              section: n,
            ...
            const c = t.append("g").attr("class", "taskWrapper"),
              p = T(c, e, n, o).height;
            if (
              (i.l.debug("taskHeight after draw", p),
            ...
            (s += 200), d && !(0, i.g)().timeline.disableMulticolor && n++;
          }
          r -= 10;
        },
        M = function (t, e, n, s, r, a) {
          let o = 0;
          const c = r;
          r += 100;
          for (const l of e) {
        ...
        O = {
          ...
          renderer: {
            ...
            draw: function (t, e, n, r) {
              const a = (0, i.g)(),
                o = a.leftMargin ? a.leftMargin : 50;
              r.db.clear(),
                r.parser.parse(t + "\n"),
                i.l.debug("timeline", r.db);
              const c = a.securityLevel;
              let l;
              "sandbox" === c && (l = (0, s.Ltv)("#i" + e));
              const h = (
                "sandbox" === c
                  ? (0, s.Ltv)(l.nodes()[0].contentDocument.body)
                  : (0, s.Ltv)("body")
              ).select("#" + e);
              h.append("g");
              const d = r.db.getTasks(),
                u = r.db.getCommonDb().getDiagramTitle();
              i.l.debug("task", d), L(h);
              const p = r.db.getSections();
              i.l.debug("sections", p);
              let y = 0,
                g = 0,
                f = 0,
                m = 0,
              ...
              p.forEach(function (t) {
                ...
                i.l.debug("sectionHeight before draw", e),
                  (y = Math.max(y, e + 20));
              });
              let x = 0,
                S = 0;
              i.l.debug("tasks.length", d.length);
              ...
              i.l.debug("maxSectionHeight before draw", y),
                i.l.debug("maxTaskHeight before draw", g),
                p && p.length > 0
                  ? p.forEach((t) => {
                      const e = {
                        number: v,
                      ...
                      i.l.debug("sectionNode", e);
                      const n = h.append("g"),
                        s = T(n, e, v, a);
                      i.l.debug("sectionNode output", s),
                        n.attr("transform", `translate(${_}, 50)`),
                        (b += y + 50);
                      const r = d.filter((e) => e.section === t);
                      r.length > 0 && C(h, r, v, _, b, g, a, x, S, y, !1),
                        (_ += 200 * Math.max(r.length, 1)),
                        (b = 50),
                        v++;
                    })
                  : ((k = !1), C(h, d, v, _, b, g, a, x, S, y, !0));
              const w = h.node().getBBox();
              i.l.debug("bounds", w),
                u &&
                  h
                    .append("text")
              ...
              h
                ...
                (0, i.s)(
                  void 0,
                  h,
                  a.timeline.padding ? a.timeline.padding : 50,
                  !!a.timeline.useMaxWidth && a.timeline.useMaxWidth
                );
            },
          },
          parser: l,
            ...
            `\n  .edge {\n    stroke-width: 3;\n  }\n  ${((t) => {
              ...
              for (let n = 0; n < t.THEME_COLOR_LIMIT; n++)
                (t["lineColor" + n] = t["lineColor" + n] || t["cScaleInv" + n]),
                  (0, r.A)(t["lineColor" + n])
                    ? (t["lineColor" + n] = (0, a.A)(t["lineColor" + n], 20))
                    : (t["lineColor" + n] = (0, o.A)(t["lineColor" + n], 20));
              for (let n = 0; n < t.THEME_COLOR_LIMIT; n++) {
                const i = "" + (17 - 3 * n);
    ...
    74328: (t, e, n) => {
      ...
      var i = n(59622),
        s = n(49173);
      const r = (t) => {
          const { r: e, g: n, b: r } = s.A.parse(t),
            a =
              0.2126 * i.A.channel.toLinear(e) +
              0.7152 * i.A.channel.toLinear(n) +
              0.0722 * i.A.channel.toLinear(r);
          return i.A.lang.round(a);
        },
        a = (t) => r(t) >= 0.5,
        o = (t) => !a(t);
    },
