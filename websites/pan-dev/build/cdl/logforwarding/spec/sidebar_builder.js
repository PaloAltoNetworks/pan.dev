...
var docs = ["logforwarding/api/logforwardingapi"];

// Change these variables to match your doc path
const relativePath = "logforwarding/api";
const absolutePath = "/cdl/logforwarding/api";
function genEndpoints() {
  const endpoints = [];
  // Absolute path from project root
  specs = globby.sync(["./static/cdl/logforwarding/spec/*.yaml"], {
    absolute: false,
    objectMode: true,
    deep: 1,
