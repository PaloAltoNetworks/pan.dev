...
The API Reference information for retrieving the packet capture associated with a Advanced Threat
Prevention report sample can be found [here](/threat-vault/api/getatppcaps/).
