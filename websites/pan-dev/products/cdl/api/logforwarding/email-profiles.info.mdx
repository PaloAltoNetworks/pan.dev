...
description: "To get email notifications whenever critical issues occur on your network, you can"
sidebar_label: "Email Profiles"
hide_title: true
...
<h1 className={"openapi__heading"}>Email Profiles</h1>



To get email notifications whenever critical issues occur on your network, you can
