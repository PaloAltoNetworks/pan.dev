...
<h1 className={"openapi__heading"}>Prisma Cloud Widgets API</h1>



These APIs are used to fetch the data from some of the widgets that are used to create custom dashboard.
