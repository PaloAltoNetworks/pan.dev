...
<span className={"theme-doc-version-badge badge badge--secondary"}>Version: 1.0.0-SNAPSHOT</span>

<h1 className={"openapi__heading"}>pcs-command-center API</h1>
