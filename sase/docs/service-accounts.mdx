...
* By using the Prisma SASE Multitenant Platform user interface.
  ...
  Platform](https://docs.paloaltonetworks.com/sase/prisma-sase-multitenant-platform/manage-identity-and-access/add-service-accounts).
...
* By using the Identity and Access Management APIs.
    ...
    API](/sase/api/iam/serviceaccounts#operation/createservice_account). 
    ...
    [create a new TSG](/sase/api/tenancy/tenantservicegroup#operation/post-tenancy-v1-tenant_service_groups) 
