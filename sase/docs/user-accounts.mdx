...
* You can use the [SSO user creation API](/sase/api/iam/useraccounts#operation/post-iam-v1-sso_users) 
...
[SSO user verification API](/sase/api/iam/useraccounts#operation/get-iam-v1-sso_users).


## Access Policies

As described in [Assign Roles](/sase/docs/roles-assign), you grant a user account access to 
SASE products by [applying an access policy](/sase/api/iam/accesspolicies#operation/createaccess_policy) 
