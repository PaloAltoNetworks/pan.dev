...
* [List all tenant service groups](/sase/api/tenancy/tenantservicegroup#operation/get-tenancy-v1-tenant_service_groups)
* [List tenant service group children](/sase/api/tenancy/tenantservicegroup#operation/post-tenancy-v1-tenant_service_groups-tsg_id-operations-list_children)
* [List tenant service group ancestors](/sase/api/tenancy/tenantservicegroup#operation/post-tenancy-v1-tenant_service_groups-tsg_id-operations-list_ancestors)
...
limit their reach by specifying a scope. For Authencaticaion Service, scope is specified in terms of TSGs.
...
group](/sase/api/tenancy/tenantservicegroup#operation/post-tenancy-v1-tenant_service_groups)
