module.exports = {
  sase_docs: [
    ...
    },
    {
      ...
      label: "Prisma SD-WAN",
      collapsed: true,
      items: ["docs/sdwan/sdwan",
          "docs/sdwan/legacy_getstarted",
          "docs/sdwan/prismasdwanconfig",
          "docs/sdwan/sdwan_gsg_sdk",
      ],
    },
    {
      type: "category",
  ...
  sdwan_unified_api: require("../static/sase/spec/sdwan/unified/sidebar_builder").sidebar,
  sdwan_legacy_api: require("../static/sase/spec/sdwan/legacy/sidebar_builder").sidebar,
