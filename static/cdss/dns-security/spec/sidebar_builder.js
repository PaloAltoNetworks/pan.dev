...
var docs = ["dns-security/api/dnssecurityapioverview"];

// Change these variables to match your doc path
const relativePath = "dns-security/api";
const absolutePath = "/cdss/dns-security/api";
function genEndpoints() {
  const endpoints = [];
  // Absolute path from project root
  specs = globby.sync(["./static/cdss/dns-security/spec/*.yaml"], {
    absolute: false,
    objectMode: true,
    deep: 1,
