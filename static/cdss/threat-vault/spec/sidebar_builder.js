...
var docs = ["threat-vault/api/threatapi"];

// Change these variables to match your doc path
const relativePath = "threat-vault/api";
const absolutePath = "/cdss/threat-vault/api";
function genEndpoints() {
  const endpoints = [];
  // Absolute path from project root
  specs = globby.sync(["./static/cdss/threat-vault/spec/*.yaml"], {
    absolute: false,
    objectMode: true,
    deep: 1,
