...
var docs = [
    "api/tenancy-service/tenancy-api",
];

// Change these variables to match your doc path
const relativePath = "api/tenancy-service";
const absolutePath = "/sase-services/api/tenancy-service";
function genEndpoints() {
  const endpoints = [];
  // Absolute path from project root
  specs = globby.sync(["./static/sase-services/spec/tenancy-service/*.yaml"], {
    absolute: false,
    objectMode: true,
    deep: 1,
