...
var docs = [
    "api/identity-and-access-management/iam-api",
];

// Change these variables to match your doc path
const relativePath = "api/identity-and-access-management";
const absolutePath = "/sase-services/api/identity-and-access-management";
function genEndpoints() {
  const endpoints = [];
  // Absolute path from project root
  specs = globby.sync(["./static/sase-services/spec/identity-and-access-management/*.yaml"], {
    absolute: false,
    objectMode: true,
    deep: 1,
