...
roles](/sase-services/api/identity-and-access-management/roles#operation/getroles).
You can also view this information in the multitenant user interface.

Similarly, there is an API that you can use to [list all permissions](/sase-services/api/identity-and-access-management/permissions#operation/getpermissions).
