...
- [List all tenant service groups](/sase/api/tenancy/get-a-tenant-service-group)
- [List tenant service group children](/sase/api/tenancy/list-tenant-service-group-children)
- [List tenant service group ancestors](/sase/api/tenancy/list-tenant-service-group-ancestors)
...
2. By using the [create a tenant service
   group](/sase/api/tenancy/create-a-tenant-service-group)
