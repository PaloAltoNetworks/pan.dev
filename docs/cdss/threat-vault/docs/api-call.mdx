...
The header response provides details about the current usage status. For more information about these header responses, refer to [DNS Security Access Limits](../docs/access-limits/dns-security).
```
