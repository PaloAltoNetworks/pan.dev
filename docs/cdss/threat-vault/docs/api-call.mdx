...
3. (Recommended) Review the [Cloud-Delivered Security Services Developer's Guide](/cdss/threat-vault/docs) and the API Reference guide for the API service that you wish to leverage.
