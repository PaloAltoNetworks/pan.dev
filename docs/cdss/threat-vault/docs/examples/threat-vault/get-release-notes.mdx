...
description: Stuff.
slug: /cdss/threat-vault/docs/examples/threat-vault/get-content-release-notes
hide_title: false
            ...
            "vulnerability" : {
               "new" : [
                  ...
                  },
                  {
                     ...
                     "change_data" : "new coverage",
                     "action" : "alert",
                     "attack_name" : "Adtran Personal Phone Manager Authenticated Stored XSS Vulnerability"
                  },
=====================================================================
