---
id: panos_tutorials_rulebase_to_csv
...
We will use Go in this tutorial, but the same concepts can be reused in Python using [PAN-OS-Python](/panos/docs/apis/pandevice_qs) or [pan-python](/panos/docs/apis/panpython_qs).
